...
def GenerateHDL(name,XMLFile,HDLPath,map_template_file,pkg_template_file):
  ...
  for i in device.getNodes():
    if i.count('.') == 0:
      ...
      mytree.generatePkg(pkgTemplate=wd+map_template_file)
      mytree.generateRegMap(regMapTemplate=map_template_file)
...
def LoadSlave(name,slave,tclFile,dtsiYAML,aTableYAML,parentName,map_template_file,pkg_template_file):
...
def main(addSlaveTCLPath, dtsiPath, addressTablePath, slavesFileName,map_template_file,pkg_template_file):
  ...
  #AddSlaves tcl file
  tclFile=open(addSlaveTCLPath+"/AddSlaves.tcl","w")
  tclFile.write("#================================================================================\n")
