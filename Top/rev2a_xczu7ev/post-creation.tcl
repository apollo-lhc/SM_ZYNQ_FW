...
set bd_name zynq_bd 
set build_name rev2a_xczu7ev
set autogen_path configs/$build_name/autogen/
#file mkdir configs/$autogen_path/autogen/cores

file mkdir -p $apollo_root_path/bit

source $apollo_root_path/src/ZynqPS/build_Zynq_rev2a_xczu7ev.tcl
