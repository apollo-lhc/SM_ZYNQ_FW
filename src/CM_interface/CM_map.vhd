...
architecture behavioral of CM_interface is
  ...
  signal reg_data :  slv32_array_t(integer range 0 to 63);
  constant Default_reg_data : slv32_array_t(integer range 0 to 63) := (others => x"00000000");
begin  -- architecture behavioral
    ...
    if localRdReq = '1' then
      ...
      case to_integer(unsigned(localAddress(5 downto 0))) is
        ...
        when 50 => --0x32
          ...
          localRdData( 5)            <=  reg_data(50)( 5);                                --C2C initialize
          ...
          localRdData(22)            <=  reg_data(50)(22);                                --DEBUG eyescan reset
          localRdData(23)            <=  reg_data(50)(23);                                --DEBUG eyescan trigger
        ...
        when 51 => --0x33
          ...
          localRdData(12)            <=  reg_data(51)(12);                                --DEBUG rx buf reset
          localRdData(13)            <=  reg_data(51)(13);                                --DEBUG rx CDR hold
          localRdData(14)            <=  reg_data(51)(14);                                --DEBUG rx DFE AGC HOLD
          localRdData(15)            <=  reg_data(51)(15);                                --DEBUG rx DFE AGC OVERRIDE
          localRdData(16)            <=  reg_data(51)(16);                                --DEBUG rx DFE LF HOLD
          localRdData(17)            <=  reg_data(51)(17);                                --DEBUG rx DFE LPM RESET
          localRdData(18)            <=  reg_data(51)(18);                                --DEBUG rx LPM ENABLE
          localRdData(19)            <=  reg_data(51)(19);                                --DEBUG rx LPM HF OVERRIDE enable
          localRdData(20)            <=  reg_data(51)(20);                                --DEBUG rx LPM LFKL override
          localRdData(22 downto 21)  <=  reg_data(51)(22 downto 21);                      --DEBUG rx monitor select
          localRdData(23)            <=  reg_data(51)(23);                                --DEBUG rx pcs reset
          localRdData(24)            <=  reg_data(51)(24);                                --DEBUG rx pma reset
          localRdData(25)            <=  reg_data(51)(25);                                --DEBUG rx PRBS counter reset
          localRdData(28 downto 26)  <=  reg_data(51)(28 downto 26);                      --DEBUG rx PRBS select
        when 52 => --0x34
          ...
          localRdData( 6 downto  3)  <=  reg_data(52)( 6 downto  3);                      --DEBUG tx diff control
          localRdData( 7)            <=  reg_data(52)( 7);                                --DEBUG tx inhibit
          localRdData(14 downto  8)  <=  reg_data(52)(14 downto  8);                      --DEBUG tx main cursor
          localRdData(15)            <=  reg_data(52)(15);                                --DEBUG tx pcs reset
          localRdData(16)            <=  reg_data(52)(16);                                --DEBUG tx pma reset
          localRdData(17)            <=  reg_data(52)(17);                                --DEBUG tx polarity
          localRdData(22 downto 18)  <=  reg_data(52)(22 downto 18);                      --DEBUG post cursor
          localRdData(23)            <=  reg_data(52)(23);                                --DEBUG force PRBS error
  ...
  Ctrl.CM(2).CTRL.ERROR_STATE_RESET    <=  reg_data(32)( 8);               
  Ctrl.CM(2).CTRL.ENABLE_PHY_CTRL      <=  reg_data(32)(11);               
  Ctrl.CM(2).C2C.EYESCAN_TRIGGER       <=  reg_data(50)(23);               
  Ctrl.CM(2).C2C.EYESCAN_RESET         <=  reg_data(50)(22);               
  Ctrl.CM(2).C2C.INITIALIZE            <=  reg_data(50)( 5);               
  Ctrl.CM(2).C2C.RX.DFE_LPM_RESET      <=  reg_data(51)(17);               
  Ctrl.CM(2).C2C.RX.PRBS_SEL           <=  reg_data(51)(28 downto 26);     
  Ctrl.CM(2).C2C.RX.PRBS_CNT_RST       <=  reg_data(51)(25);               
  Ctrl.CM(2).C2C.RX.PMA_RESET          <=  reg_data(51)(24);               
  Ctrl.CM(2).C2C.RX.PCS_RESET          <=  reg_data(51)(23);               
  Ctrl.CM(2).C2C.RX.MON_SEL            <=  reg_data(51)(22 downto 21);     
  Ctrl.CM(2).C2C.RX.LPM_LFKL_OVERRIDE  <=  reg_data(51)(20);               
  Ctrl.CM(2).C2C.RX.LPM_HF_OVERRIDE    <=  reg_data(51)(19);               
  Ctrl.CM(2).C2C.RX.LPM_EN             <=  reg_data(51)(18);               
  Ctrl.CM(2).C2C.RX.DFE_LF_HOLD        <=  reg_data(51)(16);               
  Ctrl.CM(2).C2C.RX.DFE_AGC_OVERRIDE   <=  reg_data(51)(15);               
  Ctrl.CM(2).C2C.RX.DFE_AGC_HOLD       <=  reg_data(51)(14);               
  Ctrl.CM(2).C2C.RX.CDR_HOLD           <=  reg_data(51)(13);               
  Ctrl.CM(2).C2C.RX.BUF_RESET          <=  reg_data(51)(12);               
  Ctrl.CM(2).C2C.TX.DIFF_CTRL          <=  reg_data(52)( 6 downto  3);     
  Ctrl.CM(2).C2C.TX.INHIBIT            <=  reg_data(52)( 7);               
  Ctrl.CM(2).C2C.TX.MAIN_CURSOR        <=  reg_data(52)(14 downto  8);     
  Ctrl.CM(2).C2C.TX.PCS_RESET          <=  reg_data(52)(15);               
  Ctrl.CM(2).C2C.TX.PMA_RESET          <=  reg_data(52)(16);               
  Ctrl.CM(2).C2C.TX.POLARITY           <=  reg_data(52)(17);               
  Ctrl.CM(2).C2C.TX.POST_CURSOR        <=  reg_data(52)(22 downto 18);     
  ...
  begin  -- process reg_writes
    if reset_axi_n = '0' then                 -- asynchronous reset (active low)
      ...
      reg_data(32)( 8)  <= DEFAULT_CM_CTRL_t.CM(2).CTRL.ERROR_STATE_RESET;
      reg_data(32)(11)  <= DEFAULT_CM_CTRL_t.CM(2).CTRL.ENABLE_PHY_CTRL;
      reg_data(50)(23)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.EYESCAN_TRIGGER;
      reg_data(50)(22)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.EYESCAN_RESET;
      reg_data(50)( 5)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.INITIALIZE;
      reg_data(51)(17)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.DFE_LPM_RESET;
      reg_data(51)(28 downto 26)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.PRBS_SEL;
      reg_data(51)(25)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.PRBS_CNT_RST;
      reg_data(51)(24)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.PMA_RESET;
      reg_data(51)(23)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.PCS_RESET;
      reg_data(51)(22 downto 21)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.MON_SEL;
      reg_data(51)(20)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.LPM_LFKL_OVERRIDE;
      reg_data(51)(19)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.LPM_HF_OVERRIDE;
      reg_data(51)(18)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.LPM_EN;
      reg_data(51)(16)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.DFE_LF_HOLD;
      reg_data(51)(15)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.DFE_AGC_OVERRIDE;
      reg_data(51)(14)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.DFE_AGC_HOLD;
      reg_data(51)(13)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.CDR_HOLD;
      reg_data(51)(12)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.BUF_RESET;
      reg_data(52)( 6 downto  3)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.TX.DIFF_CTRL;
      reg_data(52)( 7)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.TX.INHIBIT;
      reg_data(52)(14 downto  8)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.TX.MAIN_CURSOR;
      reg_data(52)(15)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.TX.PCS_RESET;
      reg_data(52)(16)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.TX.PMA_RESET;
      reg_data(52)(17)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.TX.POLARITY;
      reg_data(52)(22 downto 18)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.TX.POST_CURSOR;
      ...
      if localWrEn = '1' then
        ...
        when 32 => --0x20
          reg_data(32)( 0)                   <=  localWrData( 0);                --Tell CM uC to power-up
          reg_data(32)( 1)                   <=  localWrData( 1);                --Tell CM uC to power-up the rest of the CM
          reg_data(32)( 2)                   <=  localWrData( 2);                --Ignore power good from CM
          reg_data(32)( 8)                   <=  localWrData( 8);                --CM power is good
          reg_data(32)(11)                   <=  localWrData(11);                --phy_lane_control is enabled
        when 51 => --0x33
          reg_data(51)(12)                   <=  localWrData(12);                --DEBUG rx buf reset
          reg_data(51)(13)                   <=  localWrData(13);                --DEBUG rx CDR hold
          reg_data(51)(14)                   <=  localWrData(14);                --DEBUG rx DFE AGC HOLD
          reg_data(51)(15)                   <=  localWrData(15);                --DEBUG rx DFE AGC OVERRIDE
          reg_data(51)(16)                   <=  localWrData(16);                --DEBUG rx DFE LF HOLD
          reg_data(51)(17)                   <=  localWrData(17);                --DEBUG rx DFE LPM RESET
          reg_data(51)(18)                   <=  localWrData(18);                --DEBUG rx LPM ENABLE
          reg_data(51)(19)                   <=  localWrData(19);                --DEBUG rx LPM HF OVERRIDE enable
          reg_data(51)(20)                   <=  localWrData(20);                --DEBUG rx LPM LFKL override
          reg_data(51)(22 downto 21)         <=  localWrData(22 downto 21);      --DEBUG rx monitor select
          reg_data(51)(23)                   <=  localWrData(23);                --DEBUG rx pcs reset
          reg_data(51)(24)                   <=  localWrData(24);                --DEBUG rx pma reset
          reg_data(51)(25)                   <=  localWrData(25);                --DEBUG rx PRBS counter reset
          reg_data(51)(28 downto 26)         <=  localWrData(28 downto 26);      --DEBUG rx PRBS select
        when 50 => --0x32
          reg_data(50)( 5)                   <=  localWrData( 5);                --C2C initialize
        ...
        when 62 => --0x3e
          reg_data(62)( 7 downto  0)         <=  localWrData( 7 downto  0);      --Baud 16x counter.  Set by 50Mhz/(baudrate(hz) * 16). Nominally 27
        when 52 => --0x34
          reg_data(52)( 6 downto  3)         <=  localWrData( 6 downto  3);      --DEBUG tx diff control
          reg_data(52)( 7)                   <=  localWrData( 7);                --DEBUG tx inhibit
          reg_data(52)(14 downto  8)         <=  localWrData(14 downto  8);      --DEBUG tx main cursor
          reg_data(52)(15)                   <=  localWrData(15);                --DEBUG tx pcs reset
          reg_data(52)(16)                   <=  localWrData(16);                --DEBUG tx pma reset
          reg_data(52)(17)                   <=  localWrData(17);                --DEBUG tx polarity
          reg_data(52)(22 downto 18)         <=  localWrData(22 downto 18);      --DEBUG post cursor
          reg_data(52)(23)                   <=  localWrData(23);                --DEBUG force PRBS error
