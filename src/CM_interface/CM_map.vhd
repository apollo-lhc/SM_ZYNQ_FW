...
architecture behavioral of CM_interface is
  ...
  signal reg_data :  slv32_array_t(integer range 0 to 47);
  constant Default_reg_data : slv32_array_t(integer range 0 to 47) := (others => x"00000000");
begin  -- architecture behavioral
    ...
    if localRdReq = '1' then
      ...
      case to_integer(unsigned(localAddress(5 downto 0))) is
        ...
        when 42 => --0x2a
          ...
          localRdData( 5)            <=  reg_data(42)( 5);                             --C2C initialize
          ...
          localRdData(22)            <=  reg_data(42)(22);                             --DEBUG eyescan reset
          localRdData(23)            <=  reg_data(42)(23);                             --DEBUG eyescan trigger
        ...
        when 43 => --0x2b
          ...
          localRdData(12)            <=  reg_data(43)(12);                             --DEBUG rx buf reset
          localRdData(13)            <=  reg_data(43)(13);                             --DEBUG rx CDR hold
          localRdData(14)            <=  reg_data(43)(14);                             --DEBUG rx DFE AGC HOLD
          localRdData(15)            <=  reg_data(43)(15);                             --DEBUG rx DFE AGC OVERRIDE
          localRdData(16)            <=  reg_data(43)(16);                             --DEBUG rx DFE LF HOLD
          localRdData(17)            <=  reg_data(43)(17);                             --DEBUG rx DFE LPM RESET
          localRdData(18)            <=  reg_data(43)(18);                             --DEBUG rx LPM ENABLE
          localRdData(19)            <=  reg_data(43)(19);                             --DEBUG rx LPM HF OVERRIDE enable
          localRdData(20)            <=  reg_data(43)(20);                             --DEBUG rx LPM LFKL override
          localRdData(22 downto 21)  <=  reg_data(43)(22 downto 21);                   --DEBUG rx monitor select
          localRdData(23)            <=  reg_data(43)(23);                             --DEBUG rx pcs reset
          localRdData(24)            <=  reg_data(43)(24);                             --DEBUG rx pma reset
          localRdData(25)            <=  reg_data(43)(25);                             --DEBUG rx PRBS counter reset
          localRdData(28 downto 26)  <=  reg_data(43)(28 downto 26);                   --DEBUG rx PRBS select
        when 44 => --0x2c
          ...
          localRdData( 6 downto  3)  <=  reg_data(44)( 6 downto  3);                   --DEBUG tx diff control
          localRdData( 7)            <=  reg_data(44)( 7);                             --DEBUG tx inhibit
          localRdData(14 downto  8)  <=  reg_data(44)(14 downto  8);                   --DEBUG tx main cursor
          localRdData(15)            <=  reg_data(44)(15);                             --DEBUG tx pcs reset
          localRdData(16)            <=  reg_data(44)(16);                             --DEBUG tx pma reset
          localRdData(17)            <=  reg_data(44)(17);                             --DEBUG tx polarity
          localRdData(22 downto 18)  <=  reg_data(44)(22 downto 18);                   --DEBUG post cursor
          localRdData(23)            <=  reg_data(44)(23);                             --DEBUG force PRBS error
          localRdData(26 downto 24)  <=  reg_data(44)(26 downto 24);                   --DEBUG PRBS select
          localRdData(31 downto 27)  <=  reg_data(44)(31 downto 27);                   --DEBUG pre cursor
        when 45 => --0x2d
          localRdData( 7 downto  0)  <=  reg_data(45)( 7 downto  0);                   --Baud 16x counter.  Set by 50Mhz/(baudrate(hz) * 16). Nominally 27
        ...
        when 47 => --0x2f
          localRdData(31 downto  0)  <=  Mon.CM(2).MONITOR.AURORA_PMA_INIT_COUNT;      --Counter for aurora_pma_init
        when 18 => --0x12
        ...
        when 23 => --0x17
          localRdData(31 downto  0)  <=  Mon.CM(1).MONITOR.AURORA_PMA_INIT_COUNT;      --Counter for aurora_pma_init
        when 24 => --0x18
          localRdData( 0)            <=  reg_data(24)( 0);                             --Tell CM uC to power-up
          localRdData( 1)            <=  reg_data(24)( 1);                             --Tell CM uC to power-up the rest of the CM
          localRdData( 2)            <=  reg_data(24)( 2);                             --Ignore power good from CM
          localRdData( 3)            <=  Mon.CM(2).CTRL.PWR_GOOD;                      --CM power is good
          localRdData( 7 downto  4)  <=  Mon.CM(2).CTRL.STATE;                         --CM power up state
          localRdData( 8)            <=  reg_data(24)( 8);                             --CM power is good
          localRdData( 9)            <=  Mon.CM(2).CTRL.PWR_ENABLED;                   --power is enabled
          localRdData(10)            <=  Mon.CM(2).CTRL.IOS_ENABLED;                   --IOs to CM are enabled
          localRdData(11)            <=  reg_data(24)(11);                             --phy_lane_control is enabled
  ...
  Ctrl.CM(2).CTRL.ENABLE_UC            <=  reg_data(24)( 0);               
  Ctrl.CM(2).CTRL.ENABLE_PWR           <=  reg_data(24)( 1);               
  Ctrl.CM(2).CTRL.OVERRIDE_PWR_GOOD    <=  reg_data(24)( 2);               
  Ctrl.CM(2).CTRL.ERROR_STATE_RESET    <=  reg_data(24)( 8);               
  Ctrl.CM(2).CTRL.ENABLE_PHY_CTRL      <=  reg_data(24)(11);               
  Ctrl.CM(2).C2C.EYESCAN_TRIGGER       <=  reg_data(42)(23);               
  Ctrl.CM(2).C2C.EYESCAN_RESET         <=  reg_data(42)(22);               
  Ctrl.CM(2).C2C.INITIALIZE            <=  reg_data(42)( 5);               
  Ctrl.CM(2).C2C.RX.DFE_LPM_RESET      <=  reg_data(43)(17);               
  Ctrl.CM(2).C2C.RX.PRBS_SEL           <=  reg_data(43)(28 downto 26);     
  Ctrl.CM(2).C2C.RX.PRBS_CNT_RST       <=  reg_data(43)(25);               
  Ctrl.CM(2).C2C.RX.PMA_RESET          <=  reg_data(43)(24);               
  Ctrl.CM(2).C2C.RX.PCS_RESET          <=  reg_data(43)(23);               
  Ctrl.CM(2).C2C.RX.MON_SEL            <=  reg_data(43)(22 downto 21);     
  Ctrl.CM(2).C2C.RX.LPM_LFKL_OVERRIDE  <=  reg_data(43)(20);               
  Ctrl.CM(2).C2C.RX.LPM_HF_OVERRIDE    <=  reg_data(43)(19);               
  Ctrl.CM(2).C2C.RX.LPM_EN             <=  reg_data(43)(18);               
  Ctrl.CM(2).C2C.RX.DFE_LF_HOLD        <=  reg_data(43)(16);               
  Ctrl.CM(2).C2C.RX.DFE_AGC_OVERRIDE   <=  reg_data(43)(15);               
  Ctrl.CM(2).C2C.RX.DFE_AGC_HOLD       <=  reg_data(43)(14);               
  Ctrl.CM(2).C2C.RX.CDR_HOLD           <=  reg_data(43)(13);               
  Ctrl.CM(2).C2C.RX.BUF_RESET          <=  reg_data(43)(12);               
  Ctrl.CM(2).C2C.TX.DIFF_CTRL          <=  reg_data(44)( 6 downto  3);     
  Ctrl.CM(2).C2C.TX.INHIBIT            <=  reg_data(44)( 7);               
  Ctrl.CM(2).C2C.TX.MAIN_CURSOR        <=  reg_data(44)(14 downto  8);     
  Ctrl.CM(2).C2C.TX.PCS_RESET          <=  reg_data(44)(15);               
  Ctrl.CM(2).C2C.TX.PMA_RESET          <=  reg_data(44)(16);               
  Ctrl.CM(2).C2C.TX.POLARITY           <=  reg_data(44)(17);               
  Ctrl.CM(2).C2C.TX.POST_CURSOR        <=  reg_data(44)(22 downto 18);     
  Ctrl.CM(2).C2C.TX.PRBS_FORCE_ERR     <=  reg_data(44)(23);               
  Ctrl.CM(2).C2C.TX.PRBS_SEL           <=  reg_data(44)(26 downto 24);     
  Ctrl.CM(2).C2C.TX.PRE_CURSOR         <=  reg_data(44)(31 downto 27);     
  Ctrl.CM(2).MONITOR.COUNT_16X_BAUD    <=  reg_data(45)( 7 downto  0);     
  ...
  begin  -- process reg_writes
    if reset_axi_n = '0' then                 -- asynchronous reset (active low)
      ...
      reg_data(24)( 0)  <= DEFAULT_CM_CTRL_t.CM(2).CTRL.ENABLE_UC;
      reg_data(24)( 1)  <= DEFAULT_CM_CTRL_t.CM(2).CTRL.ENABLE_PWR;
      reg_data(24)( 2)  <= DEFAULT_CM_CTRL_t.CM(2).CTRL.OVERRIDE_PWR_GOOD;
      reg_data(24)( 8)  <= DEFAULT_CM_CTRL_t.CM(2).CTRL.ERROR_STATE_RESET;
      reg_data(24)(11)  <= DEFAULT_CM_CTRL_t.CM(2).CTRL.ENABLE_PHY_CTRL;
      reg_data(42)(23)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.EYESCAN_TRIGGER;
      reg_data(42)(22)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.EYESCAN_RESET;
      reg_data(42)( 5)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.INITIALIZE;
      reg_data(43)(17)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.DFE_LPM_RESET;
      reg_data(43)(28 downto 26)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.PRBS_SEL;
      reg_data(43)(25)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.PRBS_CNT_RST;
      reg_data(43)(24)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.PMA_RESET;
      reg_data(43)(23)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.PCS_RESET;
      reg_data(43)(22 downto 21)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.MON_SEL;
      reg_data(43)(20)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.LPM_LFKL_OVERRIDE;
      reg_data(43)(19)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.LPM_HF_OVERRIDE;
      reg_data(43)(18)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.LPM_EN;
      reg_data(43)(16)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.DFE_LF_HOLD;
      reg_data(43)(15)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.DFE_AGC_OVERRIDE;
      reg_data(43)(14)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.DFE_AGC_HOLD;
      reg_data(43)(13)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.CDR_HOLD;
      reg_data(43)(12)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.BUF_RESET;
      reg_data(44)( 6 downto  3)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.TX.DIFF_CTRL;
      reg_data(44)( 7)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.TX.INHIBIT;
      reg_data(44)(14 downto  8)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.TX.MAIN_CURSOR;
      reg_data(44)(15)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.TX.PCS_RESET;
      reg_data(44)(16)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.TX.PMA_RESET;
      reg_data(44)(17)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.TX.POLARITY;
      reg_data(44)(22 downto 18)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.TX.POST_CURSOR;
      reg_data(44)(23)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.TX.PRBS_FORCE_ERR;
      reg_data(44)(26 downto 24)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.TX.PRBS_SEL;
      reg_data(44)(31 downto 27)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.TX.PRE_CURSOR;
      reg_data(45)( 7 downto  0)  <= DEFAULT_CM_CTRL_t.CM(2).MONITOR.COUNT_16X_BAUD;
      ...
      if localWrEn = '1' then
        ...
        when 42 => --0x2a
          reg_data(42)( 5)            <=  localWrData( 5);                --C2C initialize
          reg_data(42)(22)            <=  localWrData(22);                --DEBUG eyescan reset
          reg_data(42)(23)            <=  localWrData(23);                --DEBUG eyescan trigger
        when 43 => --0x2b
          reg_data(43)(12)            <=  localWrData(12);                --DEBUG rx buf reset
          reg_data(43)(13)            <=  localWrData(13);                --DEBUG rx CDR hold
          reg_data(43)(14)            <=  localWrData(14);                --DEBUG rx DFE AGC HOLD
          reg_data(43)(15)            <=  localWrData(15);                --DEBUG rx DFE AGC OVERRIDE
          reg_data(43)(16)            <=  localWrData(16);                --DEBUG rx DFE LF HOLD
          reg_data(43)(17)            <=  localWrData(17);                --DEBUG rx DFE LPM RESET
          reg_data(43)(18)            <=  localWrData(18);                --DEBUG rx LPM ENABLE
          reg_data(43)(19)            <=  localWrData(19);                --DEBUG rx LPM HF OVERRIDE enable
          reg_data(43)(20)            <=  localWrData(20);                --DEBUG rx LPM LFKL override
          reg_data(43)(22 downto 21)  <=  localWrData(22 downto 21);      --DEBUG rx monitor select
          reg_data(43)(23)            <=  localWrData(23);                --DEBUG rx pcs reset
          reg_data(43)(24)            <=  localWrData(24);                --DEBUG rx pma reset
          reg_data(43)(25)            <=  localWrData(25);                --DEBUG rx PRBS counter reset
          reg_data(43)(28 downto 26)  <=  localWrData(28 downto 26);      --DEBUG rx PRBS select
        when 44 => --0x2c
          reg_data(44)( 6 downto  3)  <=  localWrData( 6 downto  3);      --DEBUG tx diff control
          reg_data(44)( 7)            <=  localWrData( 7);                --DEBUG tx inhibit
          reg_data(44)(14 downto  8)  <=  localWrData(14 downto  8);      --DEBUG tx main cursor
          reg_data(44)(15)            <=  localWrData(15);                --DEBUG tx pcs reset
          reg_data(44)(16)            <=  localWrData(16);                --DEBUG tx pma reset
          reg_data(44)(17)            <=  localWrData(17);                --DEBUG tx polarity
          reg_data(44)(22 downto 18)  <=  localWrData(22 downto 18);      --DEBUG post cursor
          reg_data(44)(23)            <=  localWrData(23);                --DEBUG force PRBS error
          reg_data(44)(26 downto 24)  <=  localWrData(26 downto 24);      --DEBUG PRBS select
          reg_data(44)(31 downto 27)  <=  localWrData(31 downto 27);      --DEBUG pre cursor
        when 45 => --0x2d
          reg_data(45)( 7 downto  0)  <=  localWrData( 7 downto  0);      --Baud 16x counter.  Set by 50Mhz/(baudrate(hz) * 16). Nominally 27
        when 18 => --0x12
        ...
        when 24 => --0x18
          reg_data(24)( 0)            <=  localWrData( 0);                --Tell CM uC to power-up
          reg_data(24)( 1)            <=  localWrData( 1);                --Tell CM uC to power-up the rest of the CM
          reg_data(24)( 2)            <=  localWrData( 2);                --Ignore power good from CM
          reg_data(24)( 8)            <=  localWrData( 8);                --CM power is good
          reg_data(24)(11)            <=  localWrData(11);                --phy_lane_control is enabled
