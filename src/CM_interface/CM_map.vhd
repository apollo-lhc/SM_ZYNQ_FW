...
architecture behavioral of CM_interface is
  ...
  signal reg_data :  slv32_array_t(integer range 0 to 61);
  constant Default_reg_data : slv32_array_t(integer range 0 to 61) := (others => x"00000000");
begin  -- architecture behavioral
    ...
    if localRdReq = '1' then
      ...
      case to_integer(unsigned(localAddress(5 downto 0))) is
        ...
        when 0 => --0x0
          ...
          localRdData(12)            <=  reg_data( 0)(12);                                --Reset counters in Monitor
        when 18 => --0x12
        ...
        when 23 => --0x17
          localRdData(31 downto  0)  <=  Mon.CM(1).MONITOR.C2C_INITIALIZE_ALLTIME;        --Counter for every PHYLANEUP cycle
        when 24 => --0x18
          localRdData(31 downto  0)  <=  Mon.CM(1).MONITOR.C2C_INITIALIZE_SHORTTERM;      --Counter for PHYLANEUP cycles since lase C2C INITIALIZE
        when 25 => --0x19
          localRdData(31 downto  0)  <=  Mon.CM(1).MONITOR.CONFIG_ERROR_COUNT;            --Counter for CONFIG_ERROR
        when 26 => --0x1a
          localRdData(31 downto  0)  <=  Mon.CM(1).MONITOR.LINK_ERROR_COUNT;              --Counter for LINK_ERROR
        when 27 => --0x1b
          localRdData(31 downto  0)  <=  Mon.CM(1).MONITOR.MB_ERROR_COUNT;                --Counter for MB_ERROR
        when 28 => --0x1c
          localRdData(31 downto  0)  <=  Mon.CM(1).MONITOR.PHY_HARD_ERROR_COUNT;          --Counter for PHY_HARD_ERROR
        when 29 => --0x1d
          localRdData(31 downto  0)  <=  Mon.CM(1).MONITOR.PHY_SOFT_ERROR_COUNT;          --Counter for PHY_SOFT_ERROR
        when 30 => --0x1e
          localRdData(31 downto  0)  <=  Mon.CM(1).MONITOR.PHYLANE_STATE;                 --Current state of phy_lane_control module
        when 31 => --0x1f
          localRdData( 0)            <=  reg_data(31)( 0);                                --Tell CM uC to power-up
          localRdData( 1)            <=  reg_data(31)( 1);                                --Tell CM uC to power-up the rest of the CM
          localRdData( 2)            <=  reg_data(31)( 2);                                --Ignore power good from CM
          localRdData( 3)            <=  Mon.CM(2).CTRL.PWR_GOOD;                         --CM power is good
          localRdData( 7 downto  4)  <=  Mon.CM(2).CTRL.STATE;                            --CM power up state
          localRdData( 8)            <=  reg_data(31)( 8);                                --CM power is good
          localRdData( 9)            <=  Mon.CM(2).CTRL.PWR_ENABLED;                      --power is enabled
          localRdData(10)            <=  Mon.CM(2).CTRL.IOS_ENABLED;                      --IOs to CM are enabled
          localRdData(11)            <=  reg_data(31)(11);                                --phy_lane_control is enabled
          localRdData(12)            <=  reg_data(31)(12);                                --Reset counters in Monitor
        when 49 => --0x31
          ...
          localRdData( 5)            <=  reg_data(49)( 5);                                --C2C initialize
          ...
          localRdData(22)            <=  reg_data(49)(22);                                --DEBUG eyescan reset
          localRdData(23)            <=  reg_data(49)(23);                                --DEBUG eyescan trigger
        ...
        when 50 => --0x32
          ...
          localRdData(12)            <=  reg_data(50)(12);                                --DEBUG rx buf reset
          localRdData(13)            <=  reg_data(50)(13);                                --DEBUG rx CDR hold
          localRdData(14)            <=  reg_data(50)(14);                                --DEBUG rx DFE AGC HOLD
          localRdData(15)            <=  reg_data(50)(15);                                --DEBUG rx DFE AGC OVERRIDE
          localRdData(16)            <=  reg_data(50)(16);                                --DEBUG rx DFE LF HOLD
          localRdData(17)            <=  reg_data(50)(17);                                --DEBUG rx DFE LPM RESET
          localRdData(18)            <=  reg_data(50)(18);                                --DEBUG rx LPM ENABLE
          localRdData(19)            <=  reg_data(50)(19);                                --DEBUG rx LPM HF OVERRIDE enable
          localRdData(20)            <=  reg_data(50)(20);                                --DEBUG rx LPM LFKL override
          localRdData(22 downto 21)  <=  reg_data(50)(22 downto 21);                      --DEBUG rx monitor select
          localRdData(23)            <=  reg_data(50)(23);                                --DEBUG rx pcs reset
          localRdData(24)            <=  reg_data(50)(24);                                --DEBUG rx pma reset
          localRdData(25)            <=  reg_data(50)(25);                                --DEBUG rx PRBS counter reset
          localRdData(28 downto 26)  <=  reg_data(50)(28 downto 26);                      --DEBUG rx PRBS select
        when 51 => --0x33
          ...
          localRdData( 6 downto  3)  <=  reg_data(51)( 6 downto  3);                      --DEBUG tx diff control
          localRdData( 7)            <=  reg_data(51)( 7);                                --DEBUG tx inhibit
          localRdData(14 downto  8)  <=  reg_data(51)(14 downto  8);                      --DEBUG tx main cursor
          localRdData(15)            <=  reg_data(51)(15);                                --DEBUG tx pcs reset
          localRdData(16)            <=  reg_data(51)(16);                                --DEBUG tx pma reset
          localRdData(17)            <=  reg_data(51)(17);                                --DEBUG tx polarity
          localRdData(22 downto 18)  <=  reg_data(51)(22 downto 18);                      --DEBUG post cursor
          localRdData(23)            <=  reg_data(51)(23);                                --DEBUG force PRBS error
          localRdData(26 downto 24)  <=  reg_data(51)(26 downto 24);                      --DEBUG PRBS select
          localRdData(31 downto 27)  <=  reg_data(51)(31 downto 27);                      --DEBUG pre cursor
        when 52 => --0x34
          localRdData( 7 downto  0)  <=  reg_data(52)( 7 downto  0);                      --Baud 16x counter.  Set by 50Mhz/(baudrate(hz) * 16). Nominally 27
        ...
        when 54 => --0x36
          localRdData(31 downto  0)  <=  Mon.CM(2).MONITOR.C2C_INITIALIZE_ALLTIME;        --Counter for every PHYLANEUP cycle
        when 55 => --0x37
          localRdData(31 downto  0)  <=  Mon.CM(2).MONITOR.C2C_INITIALIZE_SHORTTERM;      --Counter for PHYLANEUP cycles since lase C2C INITIALIZE
        when 56 => --0x38
          localRdData(31 downto  0)  <=  Mon.CM(2).MONITOR.CONFIG_ERROR_COUNT;            --Counter for CONFIG_ERROR
        when 57 => --0x39
          localRdData(31 downto  0)  <=  Mon.CM(2).MONITOR.LINK_ERROR_COUNT;              --Counter for LINK_ERROR
        when 58 => --0x3a
          localRdData(31 downto  0)  <=  Mon.CM(2).MONITOR.MB_ERROR_COUNT;                --Counter for MB_ERROR
        when 59 => --0x3b
          localRdData(31 downto  0)  <=  Mon.CM(2).MONITOR.PHY_HARD_ERROR_COUNT;          --Counter for PHY_HARD_ERROR
        when 60 => --0x3c
          localRdData(31 downto  0)  <=  Mon.CM(2).MONITOR.PHY_SOFT_ERROR_COUNT;          --Counter for PHY_SOFT_ERROR
        when 61 => --0x3d
          localRdData(31 downto  0)  <=  Mon.CM(2).MONITOR.PHYLANE_STATE;                 --Current state of phy_lane_control module
  ...
  Ctrl.CM(1).CTRL.RESET_COUNTERS       <=  reg_data( 0)(12);               
  ...
  Ctrl.CM(1).MONITOR.COUNT_16X_BAUD    <=  reg_data(21)( 7 downto  0);     
  Ctrl.CM(2).CTRL.ENABLE_UC            <=  reg_data(31)( 0);               
  Ctrl.CM(2).CTRL.ENABLE_PWR           <=  reg_data(31)( 1);               
  Ctrl.CM(2).CTRL.OVERRIDE_PWR_GOOD    <=  reg_data(31)( 2);               
  Ctrl.CM(2).CTRL.ERROR_STATE_RESET    <=  reg_data(31)( 8);               
  Ctrl.CM(2).CTRL.ENABLE_PHY_CTRL      <=  reg_data(31)(11);               
  Ctrl.CM(2).CTRL.RESET_COUNTERS       <=  reg_data(31)(12);               
  Ctrl.CM(2).C2C.EYESCAN_TRIGGER       <=  reg_data(49)(23);               
  Ctrl.CM(2).C2C.EYESCAN_RESET         <=  reg_data(49)(22);               
  Ctrl.CM(2).C2C.INITIALIZE            <=  reg_data(49)( 5);               
  Ctrl.CM(2).C2C.RX.DFE_LPM_RESET      <=  reg_data(50)(17);               
  Ctrl.CM(2).C2C.RX.PRBS_SEL           <=  reg_data(50)(28 downto 26);     
  Ctrl.CM(2).C2C.RX.PRBS_CNT_RST       <=  reg_data(50)(25);               
  Ctrl.CM(2).C2C.RX.PMA_RESET          <=  reg_data(50)(24);               
  Ctrl.CM(2).C2C.RX.PCS_RESET          <=  reg_data(50)(23);               
  Ctrl.CM(2).C2C.RX.MON_SEL            <=  reg_data(50)(22 downto 21);     
  Ctrl.CM(2).C2C.RX.LPM_LFKL_OVERRIDE  <=  reg_data(50)(20);               
  Ctrl.CM(2).C2C.RX.LPM_HF_OVERRIDE    <=  reg_data(50)(19);               
  Ctrl.CM(2).C2C.RX.LPM_EN             <=  reg_data(50)(18);               
  Ctrl.CM(2).C2C.RX.DFE_LF_HOLD        <=  reg_data(50)(16);               
  Ctrl.CM(2).C2C.RX.DFE_AGC_OVERRIDE   <=  reg_data(50)(15);               
  Ctrl.CM(2).C2C.RX.DFE_AGC_HOLD       <=  reg_data(50)(14);               
  Ctrl.CM(2).C2C.RX.CDR_HOLD           <=  reg_data(50)(13);               
  Ctrl.CM(2).C2C.RX.BUF_RESET          <=  reg_data(50)(12);               
  Ctrl.CM(2).C2C.TX.DIFF_CTRL          <=  reg_data(51)( 6 downto  3);     
  Ctrl.CM(2).C2C.TX.INHIBIT            <=  reg_data(51)( 7);               
  Ctrl.CM(2).C2C.TX.MAIN_CURSOR        <=  reg_data(51)(14 downto  8);     
  Ctrl.CM(2).C2C.TX.PCS_RESET          <=  reg_data(51)(15);               
  Ctrl.CM(2).C2C.TX.PMA_RESET          <=  reg_data(51)(16);               
  Ctrl.CM(2).C2C.TX.POLARITY           <=  reg_data(51)(17);               
  Ctrl.CM(2).C2C.TX.POST_CURSOR        <=  reg_data(51)(22 downto 18);     
  Ctrl.CM(2).C2C.TX.PRBS_FORCE_ERR     <=  reg_data(51)(23);               
  Ctrl.CM(2).C2C.TX.PRBS_SEL           <=  reg_data(51)(26 downto 24);     
  Ctrl.CM(2).C2C.TX.PRE_CURSOR         <=  reg_data(51)(31 downto 27);     
  Ctrl.CM(2).MONITOR.COUNT_16X_BAUD    <=  reg_data(52)( 7 downto  0);     
  ...
  begin  -- process reg_writes
    if reset_axi_n = '0' then                 -- asynchronous reset (active low)
      ...
      reg_data( 0)(12)  <= DEFAULT_CM_CTRL_t.CM(1).CTRL.RESET_COUNTERS;
      ...
      reg_data(21)( 7 downto  0)  <= DEFAULT_CM_CTRL_t.CM(1).MONITOR.COUNT_16X_BAUD;
      reg_data(31)( 0)  <= DEFAULT_CM_CTRL_t.CM(2).CTRL.ENABLE_UC;
      reg_data(31)( 1)  <= DEFAULT_CM_CTRL_t.CM(2).CTRL.ENABLE_PWR;
      reg_data(31)( 2)  <= DEFAULT_CM_CTRL_t.CM(2).CTRL.OVERRIDE_PWR_GOOD;
      reg_data(31)( 8)  <= DEFAULT_CM_CTRL_t.CM(2).CTRL.ERROR_STATE_RESET;
      reg_data(31)(11)  <= DEFAULT_CM_CTRL_t.CM(2).CTRL.ENABLE_PHY_CTRL;
      reg_data(31)(12)  <= DEFAULT_CM_CTRL_t.CM(2).CTRL.RESET_COUNTERS;
      reg_data(49)(23)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.EYESCAN_TRIGGER;
      reg_data(49)(22)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.EYESCAN_RESET;
      reg_data(49)( 5)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.INITIALIZE;
      reg_data(50)(17)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.DFE_LPM_RESET;
      reg_data(50)(28 downto 26)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.PRBS_SEL;
      reg_data(50)(25)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.PRBS_CNT_RST;
      reg_data(50)(24)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.PMA_RESET;
      reg_data(50)(23)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.PCS_RESET;
      reg_data(50)(22 downto 21)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.MON_SEL;
      reg_data(50)(20)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.LPM_LFKL_OVERRIDE;
      reg_data(50)(19)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.LPM_HF_OVERRIDE;
      reg_data(50)(18)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.LPM_EN;
      reg_data(50)(16)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.DFE_LF_HOLD;
      reg_data(50)(15)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.DFE_AGC_OVERRIDE;
      reg_data(50)(14)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.DFE_AGC_HOLD;
      reg_data(50)(13)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.CDR_HOLD;
      reg_data(50)(12)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.BUF_RESET;
      reg_data(51)( 6 downto  3)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.TX.DIFF_CTRL;
      reg_data(51)( 7)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.TX.INHIBIT;
      reg_data(51)(14 downto  8)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.TX.MAIN_CURSOR;
      reg_data(51)(15)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.TX.PCS_RESET;
      reg_data(51)(16)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.TX.PMA_RESET;
      reg_data(51)(17)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.TX.POLARITY;
      reg_data(51)(22 downto 18)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.TX.POST_CURSOR;
      reg_data(51)(23)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.TX.PRBS_FORCE_ERR;
      reg_data(51)(26 downto 24)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.TX.PRBS_SEL;
      reg_data(51)(31 downto 27)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.TX.PRE_CURSOR;
      reg_data(52)( 7 downto  0)  <= DEFAULT_CM_CTRL_t.CM(2).MONITOR.COUNT_16X_BAUD;
      ...
      if localWrEn = '1' then
        ...
        when 0 => --0x0
          ...
          reg_data( 0)(12)            <=  localWrData(12);                --Reset counters in Monitor
        when 51 => --0x33
          reg_data(51)( 6 downto  3)  <=  localWrData( 6 downto  3);      --DEBUG tx diff control
          reg_data(51)( 7)            <=  localWrData( 7);                --DEBUG tx inhibit
          reg_data(51)(14 downto  8)  <=  localWrData(14 downto  8);      --DEBUG tx main cursor
          reg_data(51)(15)            <=  localWrData(15);                --DEBUG tx pcs reset
          reg_data(51)(16)            <=  localWrData(16);                --DEBUG tx pma reset
          reg_data(51)(17)            <=  localWrData(17);                --DEBUG tx polarity
          reg_data(51)(22 downto 18)  <=  localWrData(22 downto 18);      --DEBUG post cursor
          reg_data(51)(23)            <=  localWrData(23);                --DEBUG force PRBS error
          reg_data(51)(26 downto 24)  <=  localWrData(26 downto 24);      --DEBUG PRBS select
          reg_data(51)(31 downto 27)  <=  localWrData(31 downto 27);      --DEBUG pre cursor
        when 50 => --0x32
          reg_data(50)(12)            <=  localWrData(12);                --DEBUG rx buf reset
          reg_data(50)(13)            <=  localWrData(13);                --DEBUG rx CDR hold
          reg_data(50)(14)            <=  localWrData(14);                --DEBUG rx DFE AGC HOLD
          reg_data(50)(15)            <=  localWrData(15);                --DEBUG rx DFE AGC OVERRIDE
          reg_data(50)(16)            <=  localWrData(16);                --DEBUG rx DFE LF HOLD
          reg_data(50)(17)            <=  localWrData(17);                --DEBUG rx DFE LPM RESET
          reg_data(50)(18)            <=  localWrData(18);                --DEBUG rx LPM ENABLE
          reg_data(50)(19)            <=  localWrData(19);                --DEBUG rx LPM HF OVERRIDE enable
          reg_data(50)(20)            <=  localWrData(20);                --DEBUG rx LPM LFKL override
          reg_data(50)(22 downto 21)  <=  localWrData(22 downto 21);      --DEBUG rx monitor select
          reg_data(50)(23)            <=  localWrData(23);                --DEBUG rx pcs reset
          reg_data(50)(24)            <=  localWrData(24);                --DEBUG rx pma reset
          reg_data(50)(25)            <=  localWrData(25);                --DEBUG rx PRBS counter reset
          reg_data(50)(28 downto 26)  <=  localWrData(28 downto 26);      --DEBUG rx PRBS select
        when 49 => --0x31
          reg_data(49)( 5)            <=  localWrData( 5);                --C2C initialize
          reg_data(49)(22)            <=  localWrData(22);                --DEBUG eyescan reset
          reg_data(49)(23)            <=  localWrData(23);                --DEBUG eyescan trigger
        when 18 => --0x12
        ...
        when 52 => --0x34
          reg_data(52)( 7 downto  0)  <=  localWrData( 7 downto  0);      --Baud 16x counter.  Set by 50Mhz/(baudrate(hz) * 16). Nominally 27
        when 31 => --0x1f
          reg_data(31)( 0)            <=  localWrData( 0);                --Tell CM uC to power-up
          reg_data(31)( 1)            <=  localWrData( 1);                --Tell CM uC to power-up the rest of the CM
          reg_data(31)( 2)            <=  localWrData( 2);                --Ignore power good from CM
          reg_data(31)( 8)            <=  localWrData( 8);                --CM power is good
          reg_data(31)(11)            <=  localWrData(11);                --phy_lane_control is enabled
          reg_data(31)(12)            <=  localWrData(12);                --Reset counters in Monitor
