...
begin  -- architecture behavioral
  ...
  begin  -- process reads
    ...
    if localRdReq = '1' then
      ...
      case to_integer(unsigned(localAddress(8 downto 0))) is
        ...
        when 17 => --0x11
          localRdData( 7 downto  0)  <=  Mon.CM(1).C2C.LINK_DEBUG.DMONITOR;                --DEBUG d monitor
        ...
        when 19 => --0x13
          ...
          localRdData( 9 downto  3)  <=  Mon.CM(1).C2C.LINK_DEBUG.RX.MONITOR;              --DEBUG rx status
        ...
        when 21 => --0x15
          ...
          localRdData( 6 downto  3)  <=  reg_data(21)( 6 downto  3);                       --DEBUG tx diff control
          localRdData( 7)            <=  reg_data(21)( 7);                                 --DEBUG tx inhibit
          localRdData(14 downto  8)  <=  reg_data(21)(14 downto  8);                       --DEBUG tx main cursor
          ...
          localRdData(26 downto 24)  <=  reg_data(21)(26 downto 24);                       --DEBUG PRBS select
        ...
        when 273 => --0x111
          localRdData( 7 downto  0)  <=  Mon.CM(2).C2C.LINK_DEBUG.DMONITOR;                --DEBUG d monitor
        ...
        when 275 => --0x113
          ...
          localRdData( 9 downto  3)  <=  Mon.CM(2).C2C.LINK_DEBUG.RX.MONITOR;              --DEBUG rx status
          ...
          localRdData(14)            <=  reg_data(275)(14);                                --DEBUG rx DFE AGC HOLD
          localRdData(15)            <=  reg_data(275)(15);                                --DEBUG rx DFE AGC OVERRIDE
          localRdData(16)            <=  reg_data(275)(16);                                --DEBUG rx DFE LF HOLD
          localRdData(17)            <=  reg_data(275)(17);                                --DEBUG rx DFE LPM RESET
          localRdData(18)            <=  reg_data(275)(18);                                --DEBUG rx LPM ENABLE
          localRdData(19)            <=  reg_data(275)(19);                                --DEBUG rx LPM HF OVERRIDE enable
          localRdData(20)            <=  reg_data(275)(20);                                --DEBUG rx LPM LFKL override
          localRdData(22 downto 21)  <=  reg_data(275)(22 downto 21);                      --DEBUG rx monitor select
          ...
          localRdData(28 downto 26)  <=  reg_data(275)(28 downto 26);                      --DEBUG rx PRBS select
        when 337 => --0x151
        ...
        when 277 => --0x115
          ...
          localRdData( 6 downto  3)  <=  reg_data(277)( 6 downto  3);                      --DEBUG tx diff control
          localRdData( 7)            <=  reg_data(277)( 7);                                --DEBUG tx inhibit
          localRdData(14 downto  8)  <=  reg_data(277)(14 downto  8);                      --DEBUG tx main cursor
          ...
          localRdData(26 downto 24)  <=  reg_data(277)(26 downto 24);                      --DEBUG PRBS select
  ...
  Ctrl.CM(1).C2C.LINK_DEBUG.RX.PRBS_SEL           <=  reg_data(19)(28 downto 26);      
  ...
  Ctrl.CM(1).C2C.LINK_DEBUG.RX.MON_SEL            <=  reg_data(19)(22 downto 21);      
  Ctrl.CM(1).C2C.LINK_DEBUG.RX.LPM_LFKL_OVERRIDE  <=  reg_data(19)(20);                
  Ctrl.CM(1).C2C.LINK_DEBUG.RX.LPM_HF_OVERRIDE    <=  reg_data(19)(19);                
  Ctrl.CM(1).C2C.LINK_DEBUG.RX.LPM_EN             <=  reg_data(19)(18);                
  Ctrl.CM(1).C2C.LINK_DEBUG.RX.DFE_LF_HOLD        <=  reg_data(19)(16);                
  Ctrl.CM(1).C2C.LINK_DEBUG.RX.DFE_AGC_OVERRIDE   <=  reg_data(19)(15);                
  Ctrl.CM(1).C2C.LINK_DEBUG.RX.DFE_AGC_HOLD       <=  reg_data(19)(14);                
  Ctrl.CM(1).C2C.LINK_DEBUG.RX.CDR_HOLD           <=  reg_data(19)(13);                
  Ctrl.CM(1).C2C.LINK_DEBUG.RX.BUF_RESET          <=  reg_data(19)(12);                
  Ctrl.CM(1).C2C.LINK_DEBUG.TX.DIFF_CTRL          <=  reg_data(21)( 6 downto  3);      
  Ctrl.CM(1).C2C.LINK_DEBUG.TX.INHIBIT            <=  reg_data(21)( 7);                
  Ctrl.CM(1).C2C.LINK_DEBUG.TX.MAIN_CURSOR        <=  reg_data(21)(14 downto  8);      
  ...
  Ctrl.CM(1).C2C.LINK_DEBUG.TX.PRBS_SEL           <=  reg_data(21)(26 downto 24);      
  ...
  Ctrl.CM(2).C2C.LINK_DEBUG.RX.PRBS_SEL           <=  reg_data(275)(28 downto 26);     
  ...
  Ctrl.CM(2).C2C.LINK_DEBUG.RX.MON_SEL            <=  reg_data(275)(22 downto 21);     
  Ctrl.CM(2).C2C.LINK_DEBUG.RX.LPM_LFKL_OVERRIDE  <=  reg_data(275)(20);               
  Ctrl.CM(2).C2C.LINK_DEBUG.RX.LPM_HF_OVERRIDE    <=  reg_data(275)(19);               
  Ctrl.CM(2).C2C.LINK_DEBUG.RX.LPM_EN             <=  reg_data(275)(18);               
  Ctrl.CM(2).C2C.LINK_DEBUG.RX.DFE_LF_HOLD        <=  reg_data(275)(16);               
  Ctrl.CM(2).C2C.LINK_DEBUG.RX.DFE_AGC_OVERRIDE   <=  reg_data(275)(15);               
  Ctrl.CM(2).C2C.LINK_DEBUG.RX.DFE_AGC_HOLD       <=  reg_data(275)(14);               
  Ctrl.CM(2).C2C.LINK_DEBUG.RX.CDR_HOLD           <=  reg_data(275)(13);               
  Ctrl.CM(2).C2C.LINK_DEBUG.RX.BUF_RESET          <=  reg_data(275)(12);               
  Ctrl.CM(2).C2C.LINK_DEBUG.TX.DIFF_CTRL          <=  reg_data(277)( 6 downto  3);     
  Ctrl.CM(2).C2C.LINK_DEBUG.TX.INHIBIT            <=  reg_data(277)( 7);               
  Ctrl.CM(2).C2C.LINK_DEBUG.TX.MAIN_CURSOR        <=  reg_data(277)(14 downto  8);     
  ...
  Ctrl.CM(2).C2C.LINK_DEBUG.TX.PRBS_SEL           <=  reg_data(277)(26 downto 24);     
  ...
  begin  -- process reg_writes
    if reset_axi_n = '0' then                 -- asynchronous reset (active low)
      ...
      reg_data(19)(28 downto 26)  <= DEFAULT_CM_CTRL_t.CM(1).C2C.LINK_DEBUG.RX.PRBS_SEL;
      ...
      reg_data(19)(22 downto 21)  <= DEFAULT_CM_CTRL_t.CM(1).C2C.LINK_DEBUG.RX.MON_SEL;
      reg_data(19)(20)  <= DEFAULT_CM_CTRL_t.CM(1).C2C.LINK_DEBUG.RX.LPM_LFKL_OVERRIDE;
      reg_data(19)(19)  <= DEFAULT_CM_CTRL_t.CM(1).C2C.LINK_DEBUG.RX.LPM_HF_OVERRIDE;
      reg_data(19)(18)  <= DEFAULT_CM_CTRL_t.CM(1).C2C.LINK_DEBUG.RX.LPM_EN;
      reg_data(19)(16)  <= DEFAULT_CM_CTRL_t.CM(1).C2C.LINK_DEBUG.RX.DFE_LF_HOLD;
      reg_data(19)(15)  <= DEFAULT_CM_CTRL_t.CM(1).C2C.LINK_DEBUG.RX.DFE_AGC_OVERRIDE;
      reg_data(19)(14)  <= DEFAULT_CM_CTRL_t.CM(1).C2C.LINK_DEBUG.RX.DFE_AGC_HOLD;
      ...
      reg_data(21)( 6 downto  3)  <= DEFAULT_CM_CTRL_t.CM(1).C2C.LINK_DEBUG.TX.DIFF_CTRL;
      reg_data(21)( 7)  <= DEFAULT_CM_CTRL_t.CM(1).C2C.LINK_DEBUG.TX.INHIBIT;
      reg_data(21)(14 downto  8)  <= DEFAULT_CM_CTRL_t.CM(1).C2C.LINK_DEBUG.TX.MAIN_CURSOR;
      ...
      reg_data(21)(26 downto 24)  <= DEFAULT_CM_CTRL_t.CM(1).C2C.LINK_DEBUG.TX.PRBS_SEL;
      ...
      reg_data(275)(28 downto 26)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.LINK_DEBUG.RX.PRBS_SEL;
      ...
      reg_data(275)(22 downto 21)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.LINK_DEBUG.RX.MON_SEL;
      reg_data(275)(20)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.LINK_DEBUG.RX.LPM_LFKL_OVERRIDE;
      reg_data(275)(19)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.LINK_DEBUG.RX.LPM_HF_OVERRIDE;
      reg_data(275)(18)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.LINK_DEBUG.RX.LPM_EN;
      reg_data(275)(16)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.LINK_DEBUG.RX.DFE_LF_HOLD;
      reg_data(275)(15)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.LINK_DEBUG.RX.DFE_AGC_OVERRIDE;
      reg_data(275)(14)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.LINK_DEBUG.RX.DFE_AGC_HOLD;
      ...
      reg_data(277)( 6 downto  3)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.LINK_DEBUG.TX.DIFF_CTRL;
      reg_data(277)( 7)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.LINK_DEBUG.TX.INHIBIT;
      reg_data(277)(14 downto  8)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.LINK_DEBUG.TX.MAIN_CURSOR;
      ...
      reg_data(277)(26 downto 24)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.LINK_DEBUG.TX.PRBS_SEL;
      ...
      if localWrEn = '1' then
        ...
        when 275 => --0x113
          ...
          reg_data(275)(14)                  <=  localWrData(14);                --DEBUG rx DFE AGC HOLD
          reg_data(275)(15)                  <=  localWrData(15);                --DEBUG rx DFE AGC OVERRIDE
          reg_data(275)(16)                  <=  localWrData(16);                --DEBUG rx DFE LF HOLD
          reg_data(275)(17)                  <=  localWrData(17);                --DEBUG rx DFE LPM RESET
          reg_data(275)(18)                  <=  localWrData(18);                --DEBUG rx LPM ENABLE
          reg_data(275)(19)                  <=  localWrData(19);                --DEBUG rx LPM HF OVERRIDE enable
          reg_data(275)(20)                  <=  localWrData(20);                --DEBUG rx LPM LFKL override
          reg_data(275)(22 downto 21)        <=  localWrData(22 downto 21);      --DEBUG rx monitor select
          ...
          reg_data(275)(28 downto 26)        <=  localWrData(28 downto 26);      --DEBUG rx PRBS select
        when 21 => --0x15
          reg_data(21)( 6 downto  3)         <=  localWrData( 6 downto  3);      --DEBUG tx diff control
          reg_data(21)( 7)                   <=  localWrData( 7);                --DEBUG tx inhibit
          reg_data(21)(14 downto  8)         <=  localWrData(14 downto  8);      --DEBUG tx main cursor
          ...
          reg_data(21)(26 downto 24)         <=  localWrData(26 downto 24);      --DEBUG PRBS select
        ...
        when 277 => --0x115
          reg_data(277)( 6 downto  3)        <=  localWrData( 6 downto  3);      --DEBUG tx diff control
          reg_data(277)( 7)                  <=  localWrData( 7);                --DEBUG tx inhibit
          reg_data(277)(14 downto  8)        <=  localWrData(14 downto  8);      --DEBUG tx main cursor
          ...
          reg_data(277)(26 downto 24)        <=  localWrData(26 downto 24);      --DEBUG PRBS select
