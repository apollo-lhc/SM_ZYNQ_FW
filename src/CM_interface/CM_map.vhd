...
begin  -- architecture behavioral
  ...
  begin  -- process reads
    ...
    if localRdReq = '1' then
      ...
      case to_integer(unsigned(localAddress(8 downto 0))) is
        ...
        when 21 => --0x15
          localRdData(15 downto  0)  <=  Mon.CM(1).C2C(0).LINK_DEBUG.DMONITOR;                -- DEBUG d monitor
          localRdData(16)            <=  Mon.CM(1).C2C(0).LINK_DEBUG.QPLL_LOCK;               -- DEBUG cplllock
        ...
        when 277 => --0x115
          localRdData(15 downto  0)  <=  Mon.CM(2).C2C(0).LINK_DEBUG.DMONITOR;                -- DEBUG d monitor
          localRdData(16)            <=  Mon.CM(2).C2C(0).LINK_DEBUG.QPLL_LOCK;               -- DEBUG cplllock
  ...
  Ctrl.CM(1).C2C(0).STATUS.INITIALIZE             <=  reg_data(20)( 5);                
  Ctrl.CM(1).C2C(0).LINK_DEBUG.EYESCAN_RESET      <=  reg_data(21)(22);                
  Ctrl.CM(1).C2C(0).LINK_DEBUG.EYESCAN_TRIGGER    <=  reg_data(21)(23);                
  Ctrl.CM(1).C2C(0).LINK_DEBUG.PCS_RSV_DIN        <=  reg_data(22)(15 downto  0);      
  Ctrl.CM(1).C2C(0).LINK_DEBUG.RX.BUF_RESET       <=  reg_data(23)(12);                
  Ctrl.CM(1).C2C(0).LINK_DEBUG.RX.CDR_HOLD        <=  reg_data(23)(13);                
  Ctrl.CM(1).C2C(0).LINK_DEBUG.RX.DFE_LPM_RESET   <=  reg_data(23)(17);                
  Ctrl.CM(1).C2C(0).LINK_DEBUG.RX.LPM_EN          <=  reg_data(23)(18);                
  Ctrl.CM(1).C2C(0).LINK_DEBUG.RX.PCS_RESET       <=  reg_data(23)(23);                
  Ctrl.CM(1).C2C(0).LINK_DEBUG.RX.PMA_RESET       <=  reg_data(23)(24);                
  Ctrl.CM(1).C2C(0).LINK_DEBUG.RX.PRBS_CNT_RST    <=  reg_data(23)(25);                
  Ctrl.CM(1).C2C(0).LINK_DEBUG.RX.PRBS_SEL        <=  reg_data(23)(29 downto 26);      
  Ctrl.CM(1).C2C(0).LINK_DEBUG.RX.RATE            <=  reg_data(24)( 2 downto  0);      
  Ctrl.CM(1).C2C(0).LINK_DEBUG.TX.INHIBIT         <=  reg_data(25)( 7);                
  Ctrl.CM(1).C2C(0).LINK_DEBUG.TX.PCS_RESET       <=  reg_data(25)(15);                
  Ctrl.CM(1).C2C(0).LINK_DEBUG.TX.PMA_RESET       <=  reg_data(25)(16);                
  Ctrl.CM(1).C2C(0).LINK_DEBUG.TX.POLARITY        <=  reg_data(25)(17);                
  Ctrl.CM(1).C2C(0).LINK_DEBUG.TX.POST_CURSOR     <=  reg_data(25)(22 downto 18);      
  Ctrl.CM(1).C2C(0).LINK_DEBUG.TX.PRBS_FORCE_ERR  <=  reg_data(25)(23);                
  Ctrl.CM(1).C2C(0).LINK_DEBUG.TX.PRE_CURSOR      <=  reg_data(25)(31 downto 27);      
  Ctrl.CM(1).C2C(0).LINK_DEBUG.TX.PRBS_SEL        <=  reg_data(26)( 3 downto  0);      
  Ctrl.CM(1).C2C(0).LINK_DEBUG.TX.DIFF_CTRL       <=  reg_data(26)( 8 downto  4);      
  ...
  Ctrl.CM(1).C2C(1).STATUS.INITIALIZE             <=  reg_data(52)( 5);                
  Ctrl.CM(1).C2C(1).LINK_DEBUG.EYESCAN_RESET      <=  reg_data(53)(22);                
  Ctrl.CM(1).C2C(1).LINK_DEBUG.EYESCAN_TRIGGER    <=  reg_data(53)(23);                
  Ctrl.CM(1).C2C(1).LINK_DEBUG.PCS_RSV_DIN        <=  reg_data(54)(15 downto  0);      
  Ctrl.CM(1).C2C(1).LINK_DEBUG.RX.BUF_RESET       <=  reg_data(55)(12);                
  Ctrl.CM(1).C2C(1).LINK_DEBUG.RX.CDR_HOLD        <=  reg_data(55)(13);                
  Ctrl.CM(1).C2C(1).LINK_DEBUG.RX.DFE_LPM_RESET   <=  reg_data(55)(17);                
  Ctrl.CM(1).C2C(1).LINK_DEBUG.RX.LPM_EN          <=  reg_data(55)(18);                
  Ctrl.CM(1).C2C(1).LINK_DEBUG.RX.PCS_RESET       <=  reg_data(55)(23);                
  Ctrl.CM(1).C2C(1).LINK_DEBUG.RX.PMA_RESET       <=  reg_data(55)(24);                
  Ctrl.CM(1).C2C(1).LINK_DEBUG.RX.PRBS_CNT_RST    <=  reg_data(55)(25);                
  Ctrl.CM(1).C2C(1).LINK_DEBUG.RX.PRBS_SEL        <=  reg_data(55)(29 downto 26);      
  Ctrl.CM(1).C2C(1).LINK_DEBUG.RX.RATE            <=  reg_data(56)( 2 downto  0);      
  Ctrl.CM(1).C2C(1).LINK_DEBUG.TX.INHIBIT         <=  reg_data(57)( 7);                
  Ctrl.CM(1).C2C(1).LINK_DEBUG.TX.PCS_RESET       <=  reg_data(57)(15);                
  Ctrl.CM(1).C2C(1).LINK_DEBUG.TX.PMA_RESET       <=  reg_data(57)(16);                
  Ctrl.CM(1).C2C(1).LINK_DEBUG.TX.POLARITY        <=  reg_data(57)(17);                
  Ctrl.CM(1).C2C(1).LINK_DEBUG.TX.POST_CURSOR     <=  reg_data(57)(22 downto 18);      
  Ctrl.CM(1).C2C(1).LINK_DEBUG.TX.PRBS_FORCE_ERR  <=  reg_data(57)(23);                
  Ctrl.CM(1).C2C(1).LINK_DEBUG.TX.PRE_CURSOR      <=  reg_data(57)(31 downto 27);      
  Ctrl.CM(1).C2C(1).LINK_DEBUG.TX.PRBS_SEL        <=  reg_data(58)( 3 downto  0);      
  Ctrl.CM(1).C2C(1).LINK_DEBUG.TX.DIFF_CTRL       <=  reg_data(58)( 8 downto  4);      
  ...
  Ctrl.CM(2).C2C(0).STATUS.INITIALIZE             <=  reg_data(276)( 5);               
  Ctrl.CM(2).C2C(0).LINK_DEBUG.EYESCAN_RESET      <=  reg_data(277)(22);               
  Ctrl.CM(2).C2C(0).LINK_DEBUG.EYESCAN_TRIGGER    <=  reg_data(277)(23);               
  Ctrl.CM(2).C2C(0).LINK_DEBUG.PCS_RSV_DIN        <=  reg_data(278)(15 downto  0);     
  Ctrl.CM(2).C2C(0).LINK_DEBUG.RX.BUF_RESET       <=  reg_data(279)(12);               
  Ctrl.CM(2).C2C(0).LINK_DEBUG.RX.CDR_HOLD        <=  reg_data(279)(13);               
  Ctrl.CM(2).C2C(0).LINK_DEBUG.RX.DFE_LPM_RESET   <=  reg_data(279)(17);               
  Ctrl.CM(2).C2C(0).LINK_DEBUG.RX.LPM_EN          <=  reg_data(279)(18);               
  Ctrl.CM(2).C2C(0).LINK_DEBUG.RX.PCS_RESET       <=  reg_data(279)(23);               
  Ctrl.CM(2).C2C(0).LINK_DEBUG.RX.PMA_RESET       <=  reg_data(279)(24);               
  Ctrl.CM(2).C2C(0).LINK_DEBUG.RX.PRBS_CNT_RST    <=  reg_data(279)(25);               
  Ctrl.CM(2).C2C(0).LINK_DEBUG.RX.PRBS_SEL        <=  reg_data(279)(29 downto 26);     
  Ctrl.CM(2).C2C(0).LINK_DEBUG.RX.RATE            <=  reg_data(280)( 2 downto  0);     
  Ctrl.CM(2).C2C(0).LINK_DEBUG.TX.INHIBIT         <=  reg_data(281)( 7);               
  Ctrl.CM(2).C2C(0).LINK_DEBUG.TX.PCS_RESET       <=  reg_data(281)(15);               
  Ctrl.CM(2).C2C(0).LINK_DEBUG.TX.PMA_RESET       <=  reg_data(281)(16);               
  Ctrl.CM(2).C2C(0).LINK_DEBUG.TX.POLARITY        <=  reg_data(281)(17);               
  Ctrl.CM(2).C2C(0).LINK_DEBUG.TX.POST_CURSOR     <=  reg_data(281)(22 downto 18);     
  Ctrl.CM(2).C2C(0).LINK_DEBUG.TX.PRBS_FORCE_ERR  <=  reg_data(281)(23);               
  Ctrl.CM(2).C2C(0).LINK_DEBUG.TX.PRE_CURSOR      <=  reg_data(281)(31 downto 27);     
  Ctrl.CM(2).C2C(0).LINK_DEBUG.TX.PRBS_SEL        <=  reg_data(282)( 3 downto  0);     
  Ctrl.CM(2).C2C(0).LINK_DEBUG.TX.DIFF_CTRL       <=  reg_data(282)( 8 downto  4);     
  ...
  Ctrl.CM(2).C2C(1).STATUS.INITIALIZE             <=  reg_data(308)( 5);               
  Ctrl.CM(2).C2C(1).LINK_DEBUG.EYESCAN_RESET      <=  reg_data(309)(22);               
  Ctrl.CM(2).C2C(1).LINK_DEBUG.EYESCAN_TRIGGER    <=  reg_data(309)(23);               
  Ctrl.CM(2).C2C(1).LINK_DEBUG.PCS_RSV_DIN        <=  reg_data(310)(15 downto  0);     
  Ctrl.CM(2).C2C(1).LINK_DEBUG.RX.BUF_RESET       <=  reg_data(311)(12);               
  Ctrl.CM(2).C2C(1).LINK_DEBUG.RX.CDR_HOLD        <=  reg_data(311)(13);               
  Ctrl.CM(2).C2C(1).LINK_DEBUG.RX.DFE_LPM_RESET   <=  reg_data(311)(17);               
  Ctrl.CM(2).C2C(1).LINK_DEBUG.RX.LPM_EN          <=  reg_data(311)(18);               
  Ctrl.CM(2).C2C(1).LINK_DEBUG.RX.PCS_RESET       <=  reg_data(311)(23);               
  Ctrl.CM(2).C2C(1).LINK_DEBUG.RX.PMA_RESET       <=  reg_data(311)(24);               
  Ctrl.CM(2).C2C(1).LINK_DEBUG.RX.PRBS_CNT_RST    <=  reg_data(311)(25);               
  Ctrl.CM(2).C2C(1).LINK_DEBUG.RX.PRBS_SEL        <=  reg_data(311)(29 downto 26);     
  Ctrl.CM(2).C2C(1).LINK_DEBUG.RX.RATE            <=  reg_data(312)( 2 downto  0);     
  Ctrl.CM(2).C2C(1).LINK_DEBUG.TX.INHIBIT         <=  reg_data(313)( 7);               
  Ctrl.CM(2).C2C(1).LINK_DEBUG.TX.PCS_RESET       <=  reg_data(313)(15);               
  Ctrl.CM(2).C2C(1).LINK_DEBUG.TX.PMA_RESET       <=  reg_data(313)(16);               
  Ctrl.CM(2).C2C(1).LINK_DEBUG.TX.POLARITY        <=  reg_data(313)(17);               
  Ctrl.CM(2).C2C(1).LINK_DEBUG.TX.POST_CURSOR     <=  reg_data(313)(22 downto 18);     
  Ctrl.CM(2).C2C(1).LINK_DEBUG.TX.PRBS_FORCE_ERR  <=  reg_data(313)(23);               
  Ctrl.CM(2).C2C(1).LINK_DEBUG.TX.PRE_CURSOR      <=  reg_data(313)(31 downto 27);     
  Ctrl.CM(2).C2C(1).LINK_DEBUG.TX.PRBS_SEL        <=  reg_data(314)( 3 downto  0);     
  Ctrl.CM(2).C2C(1).LINK_DEBUG.TX.DIFF_CTRL       <=  reg_data(314)( 8 downto  4);     
  ...
  begin  -- process reg_writes
    if reset_axi_n = '0' then                 -- asynchronous reset (active low)
      ...
      reg_data(20)( 5)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(0).STATUS.INITIALIZE;
      reg_data(21)(22)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(0).LINK_DEBUG.EYESCAN_RESET;
      reg_data(21)(23)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(0).LINK_DEBUG.EYESCAN_TRIGGER;
      reg_data(22)(15 downto  0)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(0).LINK_DEBUG.PCS_RSV_DIN;
      reg_data(23)(12)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(0).LINK_DEBUG.RX.BUF_RESET;
      reg_data(23)(13)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(0).LINK_DEBUG.RX.CDR_HOLD;
      reg_data(23)(17)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(0).LINK_DEBUG.RX.DFE_LPM_RESET;
      reg_data(23)(18)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(0).LINK_DEBUG.RX.LPM_EN;
      reg_data(23)(23)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(0).LINK_DEBUG.RX.PCS_RESET;
      reg_data(23)(24)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(0).LINK_DEBUG.RX.PMA_RESET;
      reg_data(23)(25)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(0).LINK_DEBUG.RX.PRBS_CNT_RST;
      reg_data(23)(29 downto 26)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(0).LINK_DEBUG.RX.PRBS_SEL;
      reg_data(24)( 2 downto  0)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(0).LINK_DEBUG.RX.RATE;
      reg_data(25)( 7)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(0).LINK_DEBUG.TX.INHIBIT;
      reg_data(25)(15)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(0).LINK_DEBUG.TX.PCS_RESET;
      reg_data(25)(16)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(0).LINK_DEBUG.TX.PMA_RESET;
      reg_data(25)(17)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(0).LINK_DEBUG.TX.POLARITY;
      reg_data(25)(22 downto 18)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(0).LINK_DEBUG.TX.POST_CURSOR;
      reg_data(25)(23)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(0).LINK_DEBUG.TX.PRBS_FORCE_ERR;
      reg_data(25)(31 downto 27)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(0).LINK_DEBUG.TX.PRE_CURSOR;
      reg_data(26)( 3 downto  0)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(0).LINK_DEBUG.TX.PRBS_SEL;
      reg_data(26)( 8 downto  4)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(0).LINK_DEBUG.TX.DIFF_CTRL;
      ...
      reg_data(52)( 5)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).STATUS.INITIALIZE;
      reg_data(53)(22)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.EYESCAN_RESET;
      reg_data(53)(23)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.EYESCAN_TRIGGER;
      reg_data(54)(15 downto  0)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.PCS_RSV_DIN;
      reg_data(55)(12)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.RX.BUF_RESET;
      reg_data(55)(13)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.RX.CDR_HOLD;
      reg_data(55)(17)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.RX.DFE_LPM_RESET;
      reg_data(55)(18)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.RX.LPM_EN;
      reg_data(55)(23)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.RX.PCS_RESET;
      reg_data(55)(24)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.RX.PMA_RESET;
      reg_data(55)(25)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.RX.PRBS_CNT_RST;
      reg_data(55)(29 downto 26)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.RX.PRBS_SEL;
      reg_data(56)( 2 downto  0)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.RX.RATE;
      reg_data(57)( 7)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.TX.INHIBIT;
      reg_data(57)(15)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.TX.PCS_RESET;
      reg_data(57)(16)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.TX.PMA_RESET;
      reg_data(57)(17)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.TX.POLARITY;
      reg_data(57)(22 downto 18)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.TX.POST_CURSOR;
      reg_data(57)(23)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.TX.PRBS_FORCE_ERR;
      reg_data(57)(31 downto 27)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.TX.PRE_CURSOR;
      reg_data(58)( 3 downto  0)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.TX.PRBS_SEL;
      reg_data(58)( 8 downto  4)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.TX.DIFF_CTRL;
      ...
      reg_data(276)( 5)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(0).STATUS.INITIALIZE;
      reg_data(277)(22)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(0).LINK_DEBUG.EYESCAN_RESET;
      reg_data(277)(23)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(0).LINK_DEBUG.EYESCAN_TRIGGER;
      reg_data(278)(15 downto  0)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(0).LINK_DEBUG.PCS_RSV_DIN;
      reg_data(279)(12)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(0).LINK_DEBUG.RX.BUF_RESET;
      reg_data(279)(13)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(0).LINK_DEBUG.RX.CDR_HOLD;
      reg_data(279)(17)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(0).LINK_DEBUG.RX.DFE_LPM_RESET;
      reg_data(279)(18)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(0).LINK_DEBUG.RX.LPM_EN;
      reg_data(279)(23)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(0).LINK_DEBUG.RX.PCS_RESET;
      reg_data(279)(24)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(0).LINK_DEBUG.RX.PMA_RESET;
      reg_data(279)(25)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(0).LINK_DEBUG.RX.PRBS_CNT_RST;
      reg_data(279)(29 downto 26)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(0).LINK_DEBUG.RX.PRBS_SEL;
      reg_data(280)( 2 downto  0)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(0).LINK_DEBUG.RX.RATE;
      reg_data(281)( 7)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(0).LINK_DEBUG.TX.INHIBIT;
      reg_data(281)(15)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(0).LINK_DEBUG.TX.PCS_RESET;
      reg_data(281)(16)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(0).LINK_DEBUG.TX.PMA_RESET;
      reg_data(281)(17)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(0).LINK_DEBUG.TX.POLARITY;
      reg_data(281)(22 downto 18)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(0).LINK_DEBUG.TX.POST_CURSOR;
      reg_data(281)(23)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(0).LINK_DEBUG.TX.PRBS_FORCE_ERR;
      reg_data(281)(31 downto 27)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(0).LINK_DEBUG.TX.PRE_CURSOR;
      reg_data(282)( 3 downto  0)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(0).LINK_DEBUG.TX.PRBS_SEL;
      reg_data(282)( 8 downto  4)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(0).LINK_DEBUG.TX.DIFF_CTRL;
      ...
      reg_data(308)( 5)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).STATUS.INITIALIZE;
      reg_data(309)(22)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.EYESCAN_RESET;
      reg_data(309)(23)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.EYESCAN_TRIGGER;
      reg_data(310)(15 downto  0)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.PCS_RSV_DIN;
      reg_data(311)(12)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.RX.BUF_RESET;
      reg_data(311)(13)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.RX.CDR_HOLD;
      reg_data(311)(17)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.RX.DFE_LPM_RESET;
      reg_data(311)(18)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.RX.LPM_EN;
      reg_data(311)(23)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.RX.PCS_RESET;
      reg_data(311)(24)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.RX.PMA_RESET;
      reg_data(311)(25)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.RX.PRBS_CNT_RST;
      reg_data(311)(29 downto 26)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.RX.PRBS_SEL;
      reg_data(312)( 2 downto  0)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.RX.RATE;
      reg_data(313)( 7)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.TX.INHIBIT;
      reg_data(313)(15)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.TX.PCS_RESET;
      reg_data(313)(16)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.TX.PMA_RESET;
      reg_data(313)(17)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.TX.POLARITY;
      reg_data(313)(22 downto 18)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.TX.POST_CURSOR;
      reg_data(313)(23)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.TX.PRBS_FORCE_ERR;
      reg_data(313)(31 downto 27)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.TX.PRE_CURSOR;
      reg_data(314)( 3 downto  0)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.TX.PRBS_SEL;
      reg_data(314)( 8 downto  4)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.TX.DIFF_CTRL;
