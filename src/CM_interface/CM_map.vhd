...
begin  -- architecture behavioral
    ...
    if localRdReq = '1' then
      ...
      case to_integer(unsigned(localAddress(8 downto 0))) is
        ...
        when 23 => --0x17
          ...
          localRdData(14)            <=  reg_data(23)(14);                                    --DEBUG rx DFE AGC HOLD
          localRdData(15)            <=  reg_data(23)(15);                                    --DEBUG rx DFE AGC OVERRIDE
          localRdData(16)            <=  reg_data(23)(16);                                    --DEBUG rx DFE LF HOLD
          localRdData(17)            <=  reg_data(23)(17);                                    --DEBUG rx DFE LPM RESET
          localRdData(18)            <=  reg_data(23)(18);                                    --DEBUG rx LPM ENABLE
          localRdData(19)            <=  reg_data(23)(19);                                    --DEBUG rx LPM HF OVERRIDE enable
          localRdData(20)            <=  reg_data(23)(20);                                    --DEBUG rx LPM LFKL override
          localRdData(22 downto 21)  <=  reg_data(23)(22 downto 21);                          --DEBUG rx monitor select
          ...
          localRdData(28 downto 26)  <=  reg_data(23)(28 downto 26);                          --DEBUG rx PRBS select
        when 25 => --0x19
          ...
          localRdData( 6 downto  3)  <=  reg_data(25)( 6 downto  3);                          --DEBUG tx diff control
          localRdData( 7)            <=  reg_data(25)( 7);                                    --DEBUG tx inhibit
          localRdData(14 downto  8)  <=  reg_data(25)(14 downto  8);                          --DEBUG tx main cursor
          ...
          localRdData(26 downto 24)  <=  reg_data(25)(26 downto 24);                          --DEBUG PRBS select
        ...
        when 55 => --0x37
          ...
          localRdData(14)            <=  reg_data(55)(14);                                    --DEBUG rx DFE AGC HOLD
          localRdData(15)            <=  reg_data(55)(15);                                    --DEBUG rx DFE AGC OVERRIDE
          localRdData(16)            <=  reg_data(55)(16);                                    --DEBUG rx DFE LF HOLD
          localRdData(17)            <=  reg_data(55)(17);                                    --DEBUG rx DFE LPM RESET
          localRdData(18)            <=  reg_data(55)(18);                                    --DEBUG rx LPM ENABLE
          localRdData(19)            <=  reg_data(55)(19);                                    --DEBUG rx LPM HF OVERRIDE enable
          localRdData(20)            <=  reg_data(55)(20);                                    --DEBUG rx LPM LFKL override
          localRdData(22 downto 21)  <=  reg_data(55)(22 downto 21);                          --DEBUG rx monitor select
          ...
          localRdData(28 downto 26)  <=  reg_data(55)(28 downto 26);                          --DEBUG rx PRBS select
        when 57 => --0x39
          ...
          localRdData( 6 downto  3)  <=  reg_data(57)( 6 downto  3);                          --DEBUG tx diff control
          localRdData( 7)            <=  reg_data(57)( 7);                                    --DEBUG tx inhibit
          localRdData(14 downto  8)  <=  reg_data(57)(14 downto  8);                          --DEBUG tx main cursor
          ...
          localRdData(26 downto 24)  <=  reg_data(57)(26 downto 24);                          --DEBUG PRBS select
        ...
        when 279 => --0x117
          ...
          localRdData(14)            <=  reg_data(279)(14);                                   --DEBUG rx DFE AGC HOLD
          localRdData(15)            <=  reg_data(279)(15);                                   --DEBUG rx DFE AGC OVERRIDE
          localRdData(16)            <=  reg_data(279)(16);                                   --DEBUG rx DFE LF HOLD
          localRdData(17)            <=  reg_data(279)(17);                                   --DEBUG rx DFE LPM RESET
          localRdData(18)            <=  reg_data(279)(18);                                   --DEBUG rx LPM ENABLE
          localRdData(19)            <=  reg_data(279)(19);                                   --DEBUG rx LPM HF OVERRIDE enable
          localRdData(20)            <=  reg_data(279)(20);                                   --DEBUG rx LPM LFKL override
          localRdData(22 downto 21)  <=  reg_data(279)(22 downto 21);                         --DEBUG rx monitor select
          ...
          localRdData(28 downto 26)  <=  reg_data(279)(28 downto 26);                         --DEBUG rx PRBS select
        when 281 => --0x119
          ...
          localRdData( 6 downto  3)  <=  reg_data(281)( 6 downto  3);                         --DEBUG tx diff control
          localRdData( 7)            <=  reg_data(281)( 7);                                   --DEBUG tx inhibit
          localRdData(14 downto  8)  <=  reg_data(281)(14 downto  8);                         --DEBUG tx main cursor
          ...
          localRdData(26 downto 24)  <=  reg_data(281)(26 downto 24);                         --DEBUG PRBS select
        ...
        when 311 => --0x137
          ...
          localRdData(14)            <=  reg_data(311)(14);                                   --DEBUG rx DFE AGC HOLD
          localRdData(15)            <=  reg_data(311)(15);                                   --DEBUG rx DFE AGC OVERRIDE
          localRdData(16)            <=  reg_data(311)(16);                                   --DEBUG rx DFE LF HOLD
          localRdData(17)            <=  reg_data(311)(17);                                   --DEBUG rx DFE LPM RESET
          localRdData(18)            <=  reg_data(311)(18);                                   --DEBUG rx LPM ENABLE
          localRdData(19)            <=  reg_data(311)(19);                                   --DEBUG rx LPM HF OVERRIDE enable
          localRdData(20)            <=  reg_data(311)(20);                                   --DEBUG rx LPM LFKL override
          localRdData(22 downto 21)  <=  reg_data(311)(22 downto 21);                         --DEBUG rx monitor select
          ...
          localRdData(28 downto 26)  <=  reg_data(311)(28 downto 26);                         --DEBUG rx PRBS select
        when 313 => --0x139
          ...
          localRdData( 6 downto  3)  <=  reg_data(313)( 6 downto  3);                         --DEBUG tx diff control
          localRdData( 7)            <=  reg_data(313)( 7);                                   --DEBUG tx inhibit
          localRdData(14 downto  8)  <=  reg_data(313)(14 downto  8);                         --DEBUG tx main cursor
          ...
          localRdData(26 downto 24)  <=  reg_data(313)(26 downto 24);                         --DEBUG PRBS select
  ...
  Ctrl.CM(1).C2C(1).LINK_DEBUG.RX.PRBS_SEL           <=  reg_data(23)(28 downto 26);      
  ...
  Ctrl.CM(1).C2C(1).LINK_DEBUG.RX.MON_SEL            <=  reg_data(23)(22 downto 21);      
  Ctrl.CM(1).C2C(1).LINK_DEBUG.RX.LPM_LFKL_OVERRIDE  <=  reg_data(23)(20);                
  Ctrl.CM(1).C2C(1).LINK_DEBUG.RX.LPM_HF_OVERRIDE    <=  reg_data(23)(19);                
  Ctrl.CM(1).C2C(1).LINK_DEBUG.RX.LPM_EN             <=  reg_data(23)(18);                
  Ctrl.CM(1).C2C(1).LINK_DEBUG.RX.DFE_LF_HOLD        <=  reg_data(23)(16);                
  Ctrl.CM(1).C2C(1).LINK_DEBUG.RX.DFE_AGC_OVERRIDE   <=  reg_data(23)(15);                
  Ctrl.CM(1).C2C(1).LINK_DEBUG.RX.DFE_AGC_HOLD       <=  reg_data(23)(14);                
  Ctrl.CM(1).C2C(1).LINK_DEBUG.RX.CDR_HOLD           <=  reg_data(23)(13);                
  Ctrl.CM(1).C2C(1).LINK_DEBUG.RX.BUF_RESET          <=  reg_data(23)(12);                
  Ctrl.CM(1).C2C(1).LINK_DEBUG.TX.DIFF_CTRL          <=  reg_data(25)( 6 downto  3);      
  Ctrl.CM(1).C2C(1).LINK_DEBUG.TX.INHIBIT            <=  reg_data(25)( 7);                
  Ctrl.CM(1).C2C(1).LINK_DEBUG.TX.MAIN_CURSOR        <=  reg_data(25)(14 downto  8);      
  ...
  Ctrl.CM(1).C2C(1).LINK_DEBUG.TX.PRBS_SEL           <=  reg_data(25)(26 downto 24);      
  ...
  Ctrl.CM(1).C2C(2).LINK_DEBUG.RX.PRBS_SEL           <=  reg_data(55)(28 downto 26);      
  ...
  Ctrl.CM(1).C2C(2).LINK_DEBUG.RX.MON_SEL            <=  reg_data(55)(22 downto 21);      
  Ctrl.CM(1).C2C(2).LINK_DEBUG.RX.LPM_LFKL_OVERRIDE  <=  reg_data(55)(20);                
  Ctrl.CM(1).C2C(2).LINK_DEBUG.RX.LPM_HF_OVERRIDE    <=  reg_data(55)(19);                
  Ctrl.CM(1).C2C(2).LINK_DEBUG.RX.LPM_EN             <=  reg_data(55)(18);                
  Ctrl.CM(1).C2C(2).LINK_DEBUG.RX.DFE_LF_HOLD        <=  reg_data(55)(16);                
  Ctrl.CM(1).C2C(2).LINK_DEBUG.RX.DFE_AGC_OVERRIDE   <=  reg_data(55)(15);                
  Ctrl.CM(1).C2C(2).LINK_DEBUG.RX.DFE_AGC_HOLD       <=  reg_data(55)(14);                
  Ctrl.CM(1).C2C(2).LINK_DEBUG.RX.CDR_HOLD           <=  reg_data(55)(13);                
  Ctrl.CM(1).C2C(2).LINK_DEBUG.RX.BUF_RESET          <=  reg_data(55)(12);                
  Ctrl.CM(1).C2C(2).LINK_DEBUG.TX.DIFF_CTRL          <=  reg_data(57)( 6 downto  3);      
  Ctrl.CM(1).C2C(2).LINK_DEBUG.TX.INHIBIT            <=  reg_data(57)( 7);                
  Ctrl.CM(1).C2C(2).LINK_DEBUG.TX.MAIN_CURSOR        <=  reg_data(57)(14 downto  8);      
  ...
  Ctrl.CM(2).C2C(1).LINK_DEBUG.RX.PRBS_SEL           <=  reg_data(279)(28 downto 26);     
  ...
  Ctrl.CM(2).C2C(1).LINK_DEBUG.RX.MON_SEL            <=  reg_data(279)(22 downto 21);     
  Ctrl.CM(2).C2C(1).LINK_DEBUG.RX.LPM_LFKL_OVERRIDE  <=  reg_data(279)(20);               
  Ctrl.CM(2).C2C(1).LINK_DEBUG.RX.LPM_HF_OVERRIDE    <=  reg_data(279)(19);               
  Ctrl.CM(2).C2C(1).LINK_DEBUG.RX.LPM_EN             <=  reg_data(279)(18);               
  Ctrl.CM(2).C2C(1).LINK_DEBUG.RX.DFE_LF_HOLD        <=  reg_data(279)(16);               
  Ctrl.CM(2).C2C(1).LINK_DEBUG.RX.DFE_AGC_OVERRIDE   <=  reg_data(279)(15);               
  Ctrl.CM(2).C2C(1).LINK_DEBUG.RX.DFE_AGC_HOLD       <=  reg_data(279)(14);               
  Ctrl.CM(2).C2C(1).LINK_DEBUG.RX.CDR_HOLD           <=  reg_data(279)(13);               
  Ctrl.CM(2).C2C(1).LINK_DEBUG.RX.BUF_RESET          <=  reg_data(279)(12);               
  Ctrl.CM(2).C2C(1).LINK_DEBUG.TX.DIFF_CTRL          <=  reg_data(281)( 6 downto  3);     
  Ctrl.CM(2).C2C(1).LINK_DEBUG.TX.INHIBIT            <=  reg_data(281)( 7);               
  Ctrl.CM(2).C2C(1).LINK_DEBUG.TX.MAIN_CURSOR        <=  reg_data(281)(14 downto  8);     
  ...
  Ctrl.CM(2).C2C(1).LINK_DEBUG.TX.PRBS_SEL           <=  reg_data(281)(26 downto 24);     
  ...
  Ctrl.CM(2).C2C(2).LINK_DEBUG.RX.PRBS_SEL           <=  reg_data(311)(28 downto 26);     
  ...
  Ctrl.CM(2).C2C(2).LINK_DEBUG.RX.MON_SEL            <=  reg_data(311)(22 downto 21);     
  Ctrl.CM(2).C2C(2).LINK_DEBUG.RX.LPM_LFKL_OVERRIDE  <=  reg_data(311)(20);               
  Ctrl.CM(2).C2C(2).LINK_DEBUG.RX.LPM_HF_OVERRIDE    <=  reg_data(311)(19);               
  Ctrl.CM(2).C2C(2).LINK_DEBUG.RX.LPM_EN             <=  reg_data(311)(18);               
  Ctrl.CM(2).C2C(2).LINK_DEBUG.RX.DFE_LF_HOLD        <=  reg_data(311)(16);               
  Ctrl.CM(2).C2C(2).LINK_DEBUG.RX.DFE_AGC_OVERRIDE   <=  reg_data(311)(15);               
  Ctrl.CM(2).C2C(2).LINK_DEBUG.RX.DFE_AGC_HOLD       <=  reg_data(311)(14);               
  Ctrl.CM(2).C2C(2).LINK_DEBUG.RX.CDR_HOLD           <=  reg_data(311)(13);               
  Ctrl.CM(2).C2C(2).LINK_DEBUG.RX.BUF_RESET          <=  reg_data(311)(12);               
  Ctrl.CM(2).C2C(2).LINK_DEBUG.TX.DIFF_CTRL          <=  reg_data(313)( 6 downto  3);     
  Ctrl.CM(2).C2C(2).LINK_DEBUG.TX.INHIBIT            <=  reg_data(313)( 7);               
  Ctrl.CM(2).C2C(2).LINK_DEBUG.TX.MAIN_CURSOR        <=  reg_data(313)(14 downto  8);     
  ...
  begin  -- process reg_writes
    if reset_axi_n = '0' then                 -- asynchronous reset (active low)
      ...
      reg_data(23)(28 downto 26)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.RX.PRBS_SEL;
      ...
      reg_data(23)(22 downto 21)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.RX.MON_SEL;
      reg_data(23)(20)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.RX.LPM_LFKL_OVERRIDE;
      reg_data(23)(19)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.RX.LPM_HF_OVERRIDE;
      reg_data(23)(18)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.RX.LPM_EN;
      reg_data(23)(16)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.RX.DFE_LF_HOLD;
      reg_data(23)(15)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.RX.DFE_AGC_OVERRIDE;
      reg_data(23)(14)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.RX.DFE_AGC_HOLD;
      ...
      reg_data(25)( 6 downto  3)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.TX.DIFF_CTRL;
      reg_data(25)( 7)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.TX.INHIBIT;
      reg_data(25)(14 downto  8)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.TX.MAIN_CURSOR;
      ...
      reg_data(25)(26 downto 24)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.TX.PRBS_SEL;
      ...
      reg_data(55)(28 downto 26)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(2).LINK_DEBUG.RX.PRBS_SEL;
      ...
      reg_data(55)(22 downto 21)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(2).LINK_DEBUG.RX.MON_SEL;
      reg_data(55)(20)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(2).LINK_DEBUG.RX.LPM_LFKL_OVERRIDE;
      reg_data(55)(19)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(2).LINK_DEBUG.RX.LPM_HF_OVERRIDE;
      reg_data(55)(18)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(2).LINK_DEBUG.RX.LPM_EN;
      reg_data(55)(16)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(2).LINK_DEBUG.RX.DFE_LF_HOLD;
      reg_data(55)(15)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(2).LINK_DEBUG.RX.DFE_AGC_OVERRIDE;
      reg_data(55)(14)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(2).LINK_DEBUG.RX.DFE_AGC_HOLD;
      ...
      reg_data(57)( 6 downto  3)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(2).LINK_DEBUG.TX.DIFF_CTRL;
      reg_data(57)( 7)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(2).LINK_DEBUG.TX.INHIBIT;
      reg_data(57)(14 downto  8)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(2).LINK_DEBUG.TX.MAIN_CURSOR;
      ...
      reg_data(279)(28 downto 26)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.RX.PRBS_SEL;
      ...
      reg_data(279)(22 downto 21)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.RX.MON_SEL;
      reg_data(279)(20)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.RX.LPM_LFKL_OVERRIDE;
      reg_data(279)(19)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.RX.LPM_HF_OVERRIDE;
      reg_data(279)(18)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.RX.LPM_EN;
      reg_data(279)(16)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.RX.DFE_LF_HOLD;
      reg_data(279)(15)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.RX.DFE_AGC_OVERRIDE;
      reg_data(279)(14)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.RX.DFE_AGC_HOLD;
      ...
      reg_data(281)( 6 downto  3)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.TX.DIFF_CTRL;
      reg_data(281)( 7)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.TX.INHIBIT;
      reg_data(281)(14 downto  8)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.TX.MAIN_CURSOR;
      ...
      reg_data(281)(26 downto 24)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.TX.PRBS_SEL;
      ...
      reg_data(311)(28 downto 26)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(2).LINK_DEBUG.RX.PRBS_SEL;
      ...
      reg_data(311)(22 downto 21)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(2).LINK_DEBUG.RX.MON_SEL;
      reg_data(311)(20)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(2).LINK_DEBUG.RX.LPM_LFKL_OVERRIDE;
      reg_data(311)(19)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(2).LINK_DEBUG.RX.LPM_HF_OVERRIDE;
      reg_data(311)(18)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(2).LINK_DEBUG.RX.LPM_EN;
      reg_data(311)(16)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(2).LINK_DEBUG.RX.DFE_LF_HOLD;
      reg_data(311)(15)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(2).LINK_DEBUG.RX.DFE_AGC_OVERRIDE;
      reg_data(311)(14)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(2).LINK_DEBUG.RX.DFE_AGC_HOLD;
      ...
      reg_data(313)( 6 downto  3)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(2).LINK_DEBUG.TX.DIFF_CTRL;
      reg_data(313)( 7)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(2).LINK_DEBUG.TX.INHIBIT;
      reg_data(313)(14 downto  8)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(2).LINK_DEBUG.TX.MAIN_CURSOR;
      ...
      if localWrEn = '1' then
        ...
        when 279 => --0x117
          ...
          reg_data(279)(14)                     <=  localWrData(14);                --DEBUG rx DFE AGC HOLD
          reg_data(279)(15)                     <=  localWrData(15);                --DEBUG rx DFE AGC OVERRIDE
          reg_data(279)(16)                     <=  localWrData(16);                --DEBUG rx DFE LF HOLD
          reg_data(279)(17)                     <=  localWrData(17);                --DEBUG rx DFE LPM RESET
          reg_data(279)(18)                     <=  localWrData(18);                --DEBUG rx LPM ENABLE
          reg_data(279)(19)                     <=  localWrData(19);                --DEBUG rx LPM HF OVERRIDE enable
          reg_data(279)(20)                     <=  localWrData(20);                --DEBUG rx LPM LFKL override
          reg_data(279)(22 downto 21)           <=  localWrData(22 downto 21);      --DEBUG rx monitor select
          ...
          reg_data(279)(28 downto 26)           <=  localWrData(28 downto 26);      --DEBUG rx PRBS select
        when 272 => --0x110
        ...
        when 23 => --0x17
          ...
          reg_data(23)(14)                      <=  localWrData(14);                --DEBUG rx DFE AGC HOLD
          reg_data(23)(15)                      <=  localWrData(15);                --DEBUG rx DFE AGC OVERRIDE
          reg_data(23)(16)                      <=  localWrData(16);                --DEBUG rx DFE LF HOLD
          reg_data(23)(17)                      <=  localWrData(17);                --DEBUG rx DFE LPM RESET
          reg_data(23)(18)                      <=  localWrData(18);                --DEBUG rx LPM ENABLE
          reg_data(23)(19)                      <=  localWrData(19);                --DEBUG rx LPM HF OVERRIDE enable
          reg_data(23)(20)                      <=  localWrData(20);                --DEBUG rx LPM LFKL override
          reg_data(23)(22 downto 21)            <=  localWrData(22 downto 21);      --DEBUG rx monitor select
          ...
          reg_data(23)(28 downto 26)            <=  localWrData(28 downto 26);      --DEBUG rx PRBS select
        when 25 => --0x19
          reg_data(25)( 6 downto  3)            <=  localWrData( 6 downto  3);      --DEBUG tx diff control
          reg_data(25)( 7)                      <=  localWrData( 7);                --DEBUG tx inhibit
          reg_data(25)(14 downto  8)            <=  localWrData(14 downto  8);      --DEBUG tx main cursor
          ...
          reg_data(25)(26 downto 24)            <=  localWrData(26 downto 24);      --DEBUG PRBS select
        ...
        when 55 => --0x37
          ...
          reg_data(55)(14)                      <=  localWrData(14);                --DEBUG rx DFE AGC HOLD
          reg_data(55)(15)                      <=  localWrData(15);                --DEBUG rx DFE AGC OVERRIDE
          reg_data(55)(16)                      <=  localWrData(16);                --DEBUG rx DFE LF HOLD
          reg_data(55)(17)                      <=  localWrData(17);                --DEBUG rx DFE LPM RESET
          reg_data(55)(18)                      <=  localWrData(18);                --DEBUG rx LPM ENABLE
          reg_data(55)(19)                      <=  localWrData(19);                --DEBUG rx LPM HF OVERRIDE enable
          reg_data(55)(20)                      <=  localWrData(20);                --DEBUG rx LPM LFKL override
          reg_data(55)(22 downto 21)            <=  localWrData(22 downto 21);      --DEBUG rx monitor select
          ...
          reg_data(55)(28 downto 26)            <=  localWrData(28 downto 26);      --DEBUG rx PRBS select
        when 57 => --0x39
          reg_data(57)( 6 downto  3)            <=  localWrData( 6 downto  3);      --DEBUG tx diff control
          reg_data(57)( 7)                      <=  localWrData( 7);                --DEBUG tx inhibit
          reg_data(57)(14 downto  8)            <=  localWrData(14 downto  8);      --DEBUG tx main cursor
          ...
          reg_data(57)(26 downto 24)            <=  localWrData(26 downto 24);      --DEBUG PRBS select
        ...
        when 311 => --0x137
          ...
          reg_data(311)(14)                     <=  localWrData(14);                --DEBUG rx DFE AGC HOLD
          reg_data(311)(15)                     <=  localWrData(15);                --DEBUG rx DFE AGC OVERRIDE
          reg_data(311)(16)                     <=  localWrData(16);                --DEBUG rx DFE LF HOLD
          reg_data(311)(17)                     <=  localWrData(17);                --DEBUG rx DFE LPM RESET
          reg_data(311)(18)                     <=  localWrData(18);                --DEBUG rx LPM ENABLE
          reg_data(311)(19)                     <=  localWrData(19);                --DEBUG rx LPM HF OVERRIDE enable
          reg_data(311)(20)                     <=  localWrData(20);                --DEBUG rx LPM LFKL override
          reg_data(311)(22 downto 21)           <=  localWrData(22 downto 21);      --DEBUG rx monitor select
        ...
        when 313 => --0x139
          reg_data(313)( 6 downto  3)           <=  localWrData( 6 downto  3);      --DEBUG tx diff control
          reg_data(313)( 7)                     <=  localWrData( 7);                --DEBUG tx inhibit
          reg_data(313)(14 downto  8)           <=  localWrData(14 downto  8);      --DEBUG tx main cursor
          ...
          reg_data(313)(26 downto 24)           <=  localWrData(26 downto 24);      --DEBUG PRBS select
        ...
        when 281 => --0x119
          reg_data(281)( 6 downto  3)           <=  localWrData( 6 downto  3);      --DEBUG tx diff control
          reg_data(281)( 7)                     <=  localWrData( 7);                --DEBUG tx inhibit
          reg_data(281)(14 downto  8)           <=  localWrData(14 downto  8);      --DEBUG tx main cursor
          ...
          reg_data(281)(26 downto 24)           <=  localWrData(26 downto 24);      --DEBUG PRBS select
