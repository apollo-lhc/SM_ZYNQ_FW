...
begin  -- architecture behavioral
  ...
  begin  -- process reads
    ...
    if localRdReq = '1' then
      ...
      case to_integer(unsigned(localAddress(8 downto 0))) is
        ...
        when 305 => --0x131
          localRdData( 7 downto  0)  <=  Mon.CM(2).C2C(2).LINK_DEBUG.DMONITOR;                --DEBUG d monitor
        ...
        when 307 => --0x133
          ...
          localRdData( 9 downto  3)  <=  Mon.CM(2).C2C(2).LINK_DEBUG.RX.MONITOR;              --DEBUG rx status
        ...
        when 49 => --0x31
          localRdData( 7 downto  0)  <=  Mon.CM(1).C2C(2).LINK_DEBUG.DMONITOR;                --DEBUG d monitor
        ...
        when 51 => --0x33
          ...
          localRdData( 9 downto  3)  <=  Mon.CM(1).C2C(2).LINK_DEBUG.RX.MONITOR;              --DEBUG rx status
  ...
  Ctrl.CM(1).C2C(1).STATUS.INITIALIZE                <=  reg_data(16)( 5);                
  Ctrl.CM(1).C2C(1).PHY_READ_TIME                    <=  reg_data(18)(23 downto  0);      
  Ctrl.CM(1).C2C(1).PHY_LANE_STABLE                  <=  reg_data(17)(31 downto  0);      
  Ctrl.CM(1).C2C(1).LINK_DEBUG.EYESCAN_RESET         <=  reg_data(17)(22);                
  Ctrl.CM(1).C2C(1).LINK_DEBUG.EYESCAN_TRIGGER       <=  reg_data(17)(23);                
  Ctrl.CM(1).C2C(1).LINK_DEBUG.RX.DFE_LPM_RESET      <=  reg_data(19)(17);                
  Ctrl.CM(1).C2C(1).LINK_DEBUG.RX.PRBS_SEL           <=  reg_data(19)(28 downto 26);      
  Ctrl.CM(1).C2C(1).LINK_DEBUG.RX.PRBS_CNT_RST       <=  reg_data(19)(25);                
  Ctrl.CM(1).C2C(1).LINK_DEBUG.RX.PMA_RESET          <=  reg_data(19)(24);                
  Ctrl.CM(1).C2C(1).LINK_DEBUG.RX.PCS_RESET          <=  reg_data(19)(23);                
  Ctrl.CM(1).C2C(1).LINK_DEBUG.RX.MON_SEL            <=  reg_data(19)(22 downto 21);      
  Ctrl.CM(1).C2C(1).LINK_DEBUG.RX.LPM_LFKL_OVERRIDE  <=  reg_data(19)(20);                
  Ctrl.CM(1).C2C(1).LINK_DEBUG.RX.LPM_HF_OVERRIDE    <=  reg_data(19)(19);                
  Ctrl.CM(1).C2C(1).LINK_DEBUG.RX.LPM_EN             <=  reg_data(19)(18);                
  Ctrl.CM(1).C2C(1).LINK_DEBUG.RX.DFE_LF_HOLD        <=  reg_data(19)(16);                
  Ctrl.CM(1).C2C(1).LINK_DEBUG.RX.DFE_AGC_OVERRIDE   <=  reg_data(19)(15);                
  Ctrl.CM(1).C2C(1).LINK_DEBUG.RX.DFE_AGC_HOLD       <=  reg_data(19)(14);                
  Ctrl.CM(1).C2C(1).LINK_DEBUG.RX.CDR_HOLD           <=  reg_data(19)(13);                
  Ctrl.CM(1).C2C(1).LINK_DEBUG.RX.BUF_RESET          <=  reg_data(19)(12);                
  Ctrl.CM(1).C2C(1).LINK_DEBUG.TX.DIFF_CTRL          <=  reg_data(21)( 6 downto  3);      
  Ctrl.CM(1).C2C(1).LINK_DEBUG.TX.INHIBIT            <=  reg_data(21)( 7);                
  Ctrl.CM(1).C2C(1).LINK_DEBUG.TX.MAIN_CURSOR        <=  reg_data(21)(14 downto  8);      
  Ctrl.CM(1).C2C(1).LINK_DEBUG.TX.PCS_RESET          <=  reg_data(21)(15);                
  Ctrl.CM(1).C2C(1).LINK_DEBUG.TX.PMA_RESET          <=  reg_data(21)(16);                
  Ctrl.CM(1).C2C(1).LINK_DEBUG.TX.POLARITY           <=  reg_data(21)(17);                
  Ctrl.CM(1).C2C(1).LINK_DEBUG.TX.POST_CURSOR        <=  reg_data(21)(22 downto 18);      
  Ctrl.CM(1).C2C(1).LINK_DEBUG.TX.PRBS_FORCE_ERR     <=  reg_data(21)(23);                
  Ctrl.CM(1).C2C(1).LINK_DEBUG.TX.PRBS_SEL           <=  reg_data(21)(26 downto 24);      
  Ctrl.CM(1).C2C(1).LINK_DEBUG.TX.PRE_CURSOR         <=  reg_data(21)(31 downto 27);      
  Ctrl.CM(1).C2C(2).ENABLE_PHY_CTRL                  <=  reg_data(48)(11);                
  Ctrl.CM(1).C2C(2).STATUS.INITIALIZE                <=  reg_data(48)( 5);                
  Ctrl.CM(1).C2C(2).PHY_READ_TIME                    <=  reg_data(50)(23 downto  0);      
  Ctrl.CM(1).C2C(2).PHY_LANE_STABLE                  <=  reg_data(49)(31 downto  0);      
  Ctrl.CM(1).C2C(2).LINK_DEBUG.EYESCAN_RESET         <=  reg_data(49)(22);                
  Ctrl.CM(1).C2C(2).LINK_DEBUG.EYESCAN_TRIGGER       <=  reg_data(49)(23);                
  Ctrl.CM(1).C2C(2).LINK_DEBUG.RX.DFE_LPM_RESET      <=  reg_data(51)(17);                
  Ctrl.CM(1).C2C(2).LINK_DEBUG.RX.PRBS_SEL           <=  reg_data(51)(28 downto 26);      
  Ctrl.CM(1).C2C(2).LINK_DEBUG.RX.PRBS_CNT_RST       <=  reg_data(51)(25);                
  Ctrl.CM(1).C2C(2).LINK_DEBUG.RX.PMA_RESET          <=  reg_data(51)(24);                
  Ctrl.CM(1).C2C(2).LINK_DEBUG.RX.PCS_RESET          <=  reg_data(51)(23);                
  Ctrl.CM(1).C2C(2).LINK_DEBUG.RX.MON_SEL            <=  reg_data(51)(22 downto 21);      
  Ctrl.CM(1).C2C(2).LINK_DEBUG.RX.LPM_LFKL_OVERRIDE  <=  reg_data(51)(20);                
  Ctrl.CM(1).C2C(2).LINK_DEBUG.RX.LPM_HF_OVERRIDE    <=  reg_data(51)(19);                
  Ctrl.CM(1).C2C(2).LINK_DEBUG.RX.LPM_EN             <=  reg_data(51)(18);                
  Ctrl.CM(1).C2C(2).LINK_DEBUG.RX.DFE_LF_HOLD        <=  reg_data(51)(16);                
  Ctrl.CM(1).C2C(2).LINK_DEBUG.RX.DFE_AGC_OVERRIDE   <=  reg_data(51)(15);                
  Ctrl.CM(1).C2C(2).LINK_DEBUG.RX.DFE_AGC_HOLD       <=  reg_data(51)(14);                
  Ctrl.CM(1).C2C(2).LINK_DEBUG.RX.CDR_HOLD           <=  reg_data(51)(13);                
  Ctrl.CM(1).C2C(2).LINK_DEBUG.RX.BUF_RESET          <=  reg_data(51)(12);                
  Ctrl.CM(1).C2C(2).LINK_DEBUG.TX.DIFF_CTRL          <=  reg_data(53)( 6 downto  3);      
  Ctrl.CM(1).C2C(2).LINK_DEBUG.TX.INHIBIT            <=  reg_data(53)( 7);                
  Ctrl.CM(1).C2C(2).LINK_DEBUG.TX.MAIN_CURSOR        <=  reg_data(53)(14 downto  8);      
  Ctrl.CM(1).C2C(2).LINK_DEBUG.TX.PCS_RESET          <=  reg_data(53)(15);                
  Ctrl.CM(1).C2C(2).LINK_DEBUG.TX.PMA_RESET          <=  reg_data(53)(16);                
  Ctrl.CM(1).C2C(2).LINK_DEBUG.TX.POLARITY           <=  reg_data(53)(17);                
  Ctrl.CM(1).C2C(2).LINK_DEBUG.TX.POST_CURSOR        <=  reg_data(53)(22 downto 18);      
  Ctrl.CM(1).C2C(2).LINK_DEBUG.TX.PRBS_FORCE_ERR     <=  reg_data(53)(23);                
  Ctrl.CM(1).C2C(2).LINK_DEBUG.TX.PRBS_SEL           <=  reg_data(53)(26 downto 24);      
  Ctrl.CM(1).C2C(2).LINK_DEBUG.TX.PRE_CURSOR         <=  reg_data(53)(31 downto 27);      
  ...
  Ctrl.CM(2).C2C(1).STATUS.INITIALIZE                <=  reg_data(272)( 5);               
  Ctrl.CM(2).C2C(1).PHY_READ_TIME                    <=  reg_data(274)(23 downto  0);     
  Ctrl.CM(2).C2C(1).PHY_LANE_STABLE                  <=  reg_data(273)(31 downto  0);     
  Ctrl.CM(2).C2C(1).LINK_DEBUG.EYESCAN_RESET         <=  reg_data(273)(22);               
  Ctrl.CM(2).C2C(1).LINK_DEBUG.EYESCAN_TRIGGER       <=  reg_data(273)(23);               
  Ctrl.CM(2).C2C(1).LINK_DEBUG.RX.DFE_LPM_RESET      <=  reg_data(275)(17);               
  Ctrl.CM(2).C2C(1).LINK_DEBUG.RX.PRBS_SEL           <=  reg_data(275)(28 downto 26);     
  Ctrl.CM(2).C2C(1).LINK_DEBUG.RX.PRBS_CNT_RST       <=  reg_data(275)(25);               
  Ctrl.CM(2).C2C(1).LINK_DEBUG.RX.PMA_RESET          <=  reg_data(275)(24);               
  Ctrl.CM(2).C2C(1).LINK_DEBUG.RX.PCS_RESET          <=  reg_data(275)(23);               
  Ctrl.CM(2).C2C(1).LINK_DEBUG.RX.MON_SEL            <=  reg_data(275)(22 downto 21);     
  Ctrl.CM(2).C2C(1).LINK_DEBUG.RX.LPM_LFKL_OVERRIDE  <=  reg_data(275)(20);               
  Ctrl.CM(2).C2C(1).LINK_DEBUG.RX.LPM_HF_OVERRIDE    <=  reg_data(275)(19);               
  Ctrl.CM(2).C2C(1).LINK_DEBUG.RX.LPM_EN             <=  reg_data(275)(18);               
  Ctrl.CM(2).C2C(1).LINK_DEBUG.RX.DFE_LF_HOLD        <=  reg_data(275)(16);               
  Ctrl.CM(2).C2C(1).LINK_DEBUG.RX.DFE_AGC_OVERRIDE   <=  reg_data(275)(15);               
  Ctrl.CM(2).C2C(1).LINK_DEBUG.RX.DFE_AGC_HOLD       <=  reg_data(275)(14);               
  Ctrl.CM(2).C2C(1).LINK_DEBUG.RX.CDR_HOLD           <=  reg_data(275)(13);               
  Ctrl.CM(2).C2C(1).LINK_DEBUG.RX.BUF_RESET          <=  reg_data(275)(12);               
  Ctrl.CM(2).C2C(1).LINK_DEBUG.TX.DIFF_CTRL          <=  reg_data(277)( 6 downto  3);     
  Ctrl.CM(2).C2C(1).LINK_DEBUG.TX.INHIBIT            <=  reg_data(277)( 7);               
  Ctrl.CM(2).C2C(1).LINK_DEBUG.TX.MAIN_CURSOR        <=  reg_data(277)(14 downto  8);     
  Ctrl.CM(2).C2C(1).LINK_DEBUG.TX.PCS_RESET          <=  reg_data(277)(15);               
  Ctrl.CM(2).C2C(1).LINK_DEBUG.TX.PMA_RESET          <=  reg_data(277)(16);               
  Ctrl.CM(2).C2C(1).LINK_DEBUG.TX.POLARITY           <=  reg_data(277)(17);               
  Ctrl.CM(2).C2C(1).LINK_DEBUG.TX.POST_CURSOR        <=  reg_data(277)(22 downto 18);     
  Ctrl.CM(2).C2C(1).LINK_DEBUG.TX.PRBS_FORCE_ERR     <=  reg_data(277)(23);               
  Ctrl.CM(2).C2C(1).LINK_DEBUG.TX.PRBS_SEL           <=  reg_data(277)(26 downto 24);     
  Ctrl.CM(2).C2C(1).LINK_DEBUG.TX.PRE_CURSOR         <=  reg_data(277)(31 downto 27);     
  Ctrl.CM(2).C2C(2).ENABLE_PHY_CTRL                  <=  reg_data(304)(11);               
  Ctrl.CM(2).C2C(2).STATUS.INITIALIZE                <=  reg_data(304)( 5);               
  Ctrl.CM(2).C2C(2).PHY_READ_TIME                    <=  reg_data(306)(23 downto  0);     
  Ctrl.CM(2).C2C(2).PHY_LANE_STABLE                  <=  reg_data(305)(31 downto  0);     
  Ctrl.CM(2).C2C(2).LINK_DEBUG.EYESCAN_RESET         <=  reg_data(305)(22);               
  Ctrl.CM(2).C2C(2).LINK_DEBUG.EYESCAN_TRIGGER       <=  reg_data(305)(23);               
  Ctrl.CM(2).C2C(2).LINK_DEBUG.RX.DFE_LPM_RESET      <=  reg_data(307)(17);               
  Ctrl.CM(2).C2C(2).LINK_DEBUG.RX.PRBS_SEL           <=  reg_data(307)(28 downto 26);     
  Ctrl.CM(2).C2C(2).LINK_DEBUG.RX.PRBS_CNT_RST       <=  reg_data(307)(25);               
  Ctrl.CM(2).C2C(2).LINK_DEBUG.RX.PMA_RESET          <=  reg_data(307)(24);               
  Ctrl.CM(2).C2C(2).LINK_DEBUG.RX.PCS_RESET          <=  reg_data(307)(23);               
  Ctrl.CM(2).C2C(2).LINK_DEBUG.RX.MON_SEL            <=  reg_data(307)(22 downto 21);     
  Ctrl.CM(2).C2C(2).LINK_DEBUG.RX.LPM_LFKL_OVERRIDE  <=  reg_data(307)(20);               
  Ctrl.CM(2).C2C(2).LINK_DEBUG.RX.LPM_HF_OVERRIDE    <=  reg_data(307)(19);               
  Ctrl.CM(2).C2C(2).LINK_DEBUG.RX.LPM_EN             <=  reg_data(307)(18);               
  Ctrl.CM(2).C2C(2).LINK_DEBUG.RX.DFE_LF_HOLD        <=  reg_data(307)(16);               
  Ctrl.CM(2).C2C(2).LINK_DEBUG.RX.DFE_AGC_OVERRIDE   <=  reg_data(307)(15);               
  Ctrl.CM(2).C2C(2).LINK_DEBUG.RX.DFE_AGC_HOLD       <=  reg_data(307)(14);               
  Ctrl.CM(2).C2C(2).LINK_DEBUG.RX.CDR_HOLD           <=  reg_data(307)(13);               
  Ctrl.CM(2).C2C(2).LINK_DEBUG.RX.BUF_RESET          <=  reg_data(307)(12);               
  Ctrl.CM(2).C2C(2).LINK_DEBUG.TX.DIFF_CTRL          <=  reg_data(309)( 6 downto  3);     
  Ctrl.CM(2).C2C(2).LINK_DEBUG.TX.INHIBIT            <=  reg_data(309)( 7);               
  Ctrl.CM(2).C2C(2).LINK_DEBUG.TX.MAIN_CURSOR        <=  reg_data(309)(14 downto  8);     
  Ctrl.CM(2).C2C(2).LINK_DEBUG.TX.PCS_RESET          <=  reg_data(309)(15);               
  Ctrl.CM(2).C2C(2).LINK_DEBUG.TX.PMA_RESET          <=  reg_data(309)(16);               
  Ctrl.CM(2).C2C(2).LINK_DEBUG.TX.POLARITY           <=  reg_data(309)(17);               
  Ctrl.CM(2).C2C(2).LINK_DEBUG.TX.POST_CURSOR        <=  reg_data(309)(22 downto 18);     
  Ctrl.CM(2).C2C(2).LINK_DEBUG.TX.PRBS_FORCE_ERR     <=  reg_data(309)(23);               
  Ctrl.CM(2).C2C(2).LINK_DEBUG.TX.PRBS_SEL           <=  reg_data(309)(26 downto 24);     
  Ctrl.CM(2).C2C(2).LINK_DEBUG.TX.PRE_CURSOR         <=  reg_data(309)(31 downto 27);     
  ...
  begin  -- process reg_writes
    if reset_axi_n = '0' then                 -- asynchronous reset (active low)
      ...
      reg_data(16)( 5)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).STATUS.INITIALIZE;
      ...
      reg_data(17)(22)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.EYESCAN_RESET;
      reg_data(17)(23)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.EYESCAN_TRIGGER;
      reg_data(19)(17)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.RX.DFE_LPM_RESET;
      reg_data(19)(28 downto 26)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.RX.PRBS_SEL;
      reg_data(19)(25)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.RX.PRBS_CNT_RST;
      reg_data(19)(24)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.RX.PMA_RESET;
      reg_data(19)(23)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.RX.PCS_RESET;
      reg_data(19)(22 downto 21)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.RX.MON_SEL;
      reg_data(19)(20)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.RX.LPM_LFKL_OVERRIDE;
      reg_data(19)(19)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.RX.LPM_HF_OVERRIDE;
      reg_data(19)(18)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.RX.LPM_EN;
      reg_data(19)(16)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.RX.DFE_LF_HOLD;
      reg_data(19)(15)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.RX.DFE_AGC_OVERRIDE;
      reg_data(19)(14)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.RX.DFE_AGC_HOLD;
      reg_data(19)(13)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.RX.CDR_HOLD;
      reg_data(19)(12)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.RX.BUF_RESET;
      reg_data(21)( 6 downto  3)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.TX.DIFF_CTRL;
      reg_data(21)( 7)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.TX.INHIBIT;
      reg_data(21)(14 downto  8)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.TX.MAIN_CURSOR;
      reg_data(21)(15)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.TX.PCS_RESET;
      reg_data(21)(16)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.TX.PMA_RESET;
      reg_data(21)(17)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.TX.POLARITY;
      reg_data(21)(22 downto 18)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.TX.POST_CURSOR;
      reg_data(21)(23)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.TX.PRBS_FORCE_ERR;
      reg_data(21)(26 downto 24)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.TX.PRBS_SEL;
      reg_data(21)(31 downto 27)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(1).LINK_DEBUG.TX.PRE_CURSOR;
      reg_data(48)(11)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(2).ENABLE_PHY_CTRL;
      reg_data(48)( 5)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(2).STATUS.INITIALIZE;
      ...
      reg_data(49)(22)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(2).LINK_DEBUG.EYESCAN_RESET;
      reg_data(49)(23)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(2).LINK_DEBUG.EYESCAN_TRIGGER;
      reg_data(51)(17)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(2).LINK_DEBUG.RX.DFE_LPM_RESET;
      reg_data(51)(28 downto 26)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(2).LINK_DEBUG.RX.PRBS_SEL;
      reg_data(51)(25)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(2).LINK_DEBUG.RX.PRBS_CNT_RST;
      reg_data(51)(24)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(2).LINK_DEBUG.RX.PMA_RESET;
      reg_data(51)(23)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(2).LINK_DEBUG.RX.PCS_RESET;
      reg_data(51)(22 downto 21)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(2).LINK_DEBUG.RX.MON_SEL;
      reg_data(51)(20)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(2).LINK_DEBUG.RX.LPM_LFKL_OVERRIDE;
      reg_data(51)(19)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(2).LINK_DEBUG.RX.LPM_HF_OVERRIDE;
      reg_data(51)(18)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(2).LINK_DEBUG.RX.LPM_EN;
      reg_data(51)(16)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(2).LINK_DEBUG.RX.DFE_LF_HOLD;
      reg_data(51)(15)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(2).LINK_DEBUG.RX.DFE_AGC_OVERRIDE;
      reg_data(51)(14)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(2).LINK_DEBUG.RX.DFE_AGC_HOLD;
      reg_data(51)(13)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(2).LINK_DEBUG.RX.CDR_HOLD;
      reg_data(51)(12)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(2).LINK_DEBUG.RX.BUF_RESET;
      reg_data(53)( 6 downto  3)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(2).LINK_DEBUG.TX.DIFF_CTRL;
      reg_data(53)( 7)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(2).LINK_DEBUG.TX.INHIBIT;
      reg_data(53)(14 downto  8)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(2).LINK_DEBUG.TX.MAIN_CURSOR;
      reg_data(53)(15)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(2).LINK_DEBUG.TX.PCS_RESET;
      reg_data(53)(16)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(2).LINK_DEBUG.TX.PMA_RESET;
      reg_data(53)(17)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(2).LINK_DEBUG.TX.POLARITY;
      reg_data(53)(22 downto 18)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(2).LINK_DEBUG.TX.POST_CURSOR;
      reg_data(53)(23)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(2).LINK_DEBUG.TX.PRBS_FORCE_ERR;
      reg_data(53)(26 downto 24)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(2).LINK_DEBUG.TX.PRBS_SEL;
      reg_data(53)(31 downto 27)  <= DEFAULT_CM_CTRL_t.CM(1).C2C(2).LINK_DEBUG.TX.PRE_CURSOR;
      ...
      reg_data(272)( 5)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).STATUS.INITIALIZE;
      ...
      reg_data(273)(22)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.EYESCAN_RESET;
      reg_data(273)(23)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.EYESCAN_TRIGGER;
      reg_data(275)(17)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.RX.DFE_LPM_RESET;
      reg_data(275)(28 downto 26)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.RX.PRBS_SEL;
      reg_data(275)(25)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.RX.PRBS_CNT_RST;
      reg_data(275)(24)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.RX.PMA_RESET;
      reg_data(275)(23)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.RX.PCS_RESET;
      reg_data(275)(22 downto 21)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.RX.MON_SEL;
      reg_data(275)(20)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.RX.LPM_LFKL_OVERRIDE;
      reg_data(275)(19)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.RX.LPM_HF_OVERRIDE;
      reg_data(275)(18)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.RX.LPM_EN;
      reg_data(275)(16)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.RX.DFE_LF_HOLD;
      reg_data(275)(15)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.RX.DFE_AGC_OVERRIDE;
      reg_data(275)(14)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.RX.DFE_AGC_HOLD;
      reg_data(275)(13)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.RX.CDR_HOLD;
      reg_data(275)(12)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.RX.BUF_RESET;
      reg_data(277)( 6 downto  3)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.TX.DIFF_CTRL;
      reg_data(277)( 7)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.TX.INHIBIT;
      reg_data(277)(14 downto  8)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.TX.MAIN_CURSOR;
      reg_data(277)(15)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.TX.PCS_RESET;
      reg_data(277)(16)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.TX.PMA_RESET;
      reg_data(277)(17)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.TX.POLARITY;
      reg_data(277)(22 downto 18)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.TX.POST_CURSOR;
      reg_data(277)(23)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.TX.PRBS_FORCE_ERR;
      reg_data(277)(26 downto 24)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.TX.PRBS_SEL;
      reg_data(277)(31 downto 27)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(1).LINK_DEBUG.TX.PRE_CURSOR;
      reg_data(304)(11)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(2).ENABLE_PHY_CTRL;
      reg_data(304)( 5)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(2).STATUS.INITIALIZE;
      ...
      reg_data(305)(22)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(2).LINK_DEBUG.EYESCAN_RESET;
      reg_data(305)(23)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(2).LINK_DEBUG.EYESCAN_TRIGGER;
      reg_data(307)(17)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(2).LINK_DEBUG.RX.DFE_LPM_RESET;
      reg_data(307)(28 downto 26)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(2).LINK_DEBUG.RX.PRBS_SEL;
      reg_data(307)(25)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(2).LINK_DEBUG.RX.PRBS_CNT_RST;
      reg_data(307)(24)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(2).LINK_DEBUG.RX.PMA_RESET;
      reg_data(307)(23)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(2).LINK_DEBUG.RX.PCS_RESET;
      reg_data(307)(22 downto 21)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(2).LINK_DEBUG.RX.MON_SEL;
      reg_data(307)(20)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(2).LINK_DEBUG.RX.LPM_LFKL_OVERRIDE;
      reg_data(307)(19)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(2).LINK_DEBUG.RX.LPM_HF_OVERRIDE;
      reg_data(307)(18)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(2).LINK_DEBUG.RX.LPM_EN;
      reg_data(307)(16)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(2).LINK_DEBUG.RX.DFE_LF_HOLD;
      reg_data(307)(15)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(2).LINK_DEBUG.RX.DFE_AGC_OVERRIDE;
      reg_data(307)(14)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(2).LINK_DEBUG.RX.DFE_AGC_HOLD;
      reg_data(307)(13)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(2).LINK_DEBUG.RX.CDR_HOLD;
      reg_data(307)(12)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(2).LINK_DEBUG.RX.BUF_RESET;
      reg_data(309)( 6 downto  3)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(2).LINK_DEBUG.TX.DIFF_CTRL;
      reg_data(309)( 7)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(2).LINK_DEBUG.TX.INHIBIT;
      reg_data(309)(14 downto  8)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(2).LINK_DEBUG.TX.MAIN_CURSOR;
      reg_data(309)(15)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(2).LINK_DEBUG.TX.PCS_RESET;
      reg_data(309)(16)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(2).LINK_DEBUG.TX.PMA_RESET;
      reg_data(309)(17)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(2).LINK_DEBUG.TX.POLARITY;
      reg_data(309)(22 downto 18)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(2).LINK_DEBUG.TX.POST_CURSOR;
      reg_data(309)(23)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(2).LINK_DEBUG.TX.PRBS_FORCE_ERR;
      reg_data(309)(26 downto 24)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(2).LINK_DEBUG.TX.PRBS_SEL;
      reg_data(309)(31 downto 27)  <= DEFAULT_CM_CTRL_t.CM(2).C2C(2).LINK_DEBUG.TX.PRE_CURSOR;
