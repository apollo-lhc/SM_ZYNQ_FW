...
begin  -- architecture behavioral
  ...
  begin  -- process reads
    ...
    if localRdReq = '1' then
      ...
      case to_integer(unsigned(localAddress(6 downto 0))) is
        ...
        when 41 => --0x29
          localRdData(31 downto  0)  <=  reg_data(41)(31 downto  0);                       --Count to wait for in state machine before timing out (50Mhz clk)
        when 42 => --0x2a
          localRdData( 0)            <=  reg_data(42)( 0);                                 --Tell CM uC to power-up
          localRdData( 1)            <=  reg_data(42)( 1);                                 --Tell CM uC to power-up the rest of the CM
          localRdData( 2)            <=  reg_data(42)( 2);                                 --Ignore power good from CM
          localRdData( 3)            <=  Mon.CM(2).CTRL.PWR_GOOD;                          --CM power is good
          localRdData( 7 downto  4)  <=  Mon.CM(2).CTRL.STATE;                             --CM power up state
          localRdData( 8)            <=  reg_data(42)( 8);                                 --CM power is good
          localRdData( 9)            <=  Mon.CM(2).CTRL.PWR_ENABLED;                       --power is enabled
          localRdData(10)            <=  Mon.CM(2).CTRL.IOS_ENABLED;                       --IOs to CM are enabled
          localRdData(11)            <=  reg_data(42)(11);                                 --phy_lane_control is enabled
        when 60 => --0x3c
          ...
          localRdData( 5)            <=  reg_data(60)( 5);                                 --C2C initialize
          ...
          localRdData(22)            <=  reg_data(60)(22);                                 --DEBUG eyescan reset
          localRdData(23)            <=  reg_data(60)(23);                                 --DEBUG eyescan trigger
        ...
        when 61 => --0x3d
          ...
          localRdData(12)            <=  reg_data(61)(12);                                 --DEBUG rx buf reset
          localRdData(13)            <=  reg_data(61)(13);                                 --DEBUG rx CDR hold
          localRdData(14)            <=  reg_data(61)(14);                                 --DEBUG rx DFE AGC HOLD
          localRdData(15)            <=  reg_data(61)(15);                                 --DEBUG rx DFE AGC OVERRIDE
          localRdData(16)            <=  reg_data(61)(16);                                 --DEBUG rx DFE LF HOLD
          localRdData(17)            <=  reg_data(61)(17);                                 --DEBUG rx DFE LPM RESET
          localRdData(18)            <=  reg_data(61)(18);                                 --DEBUG rx LPM ENABLE
          localRdData(19)            <=  reg_data(61)(19);                                 --DEBUG rx LPM HF OVERRIDE enable
          localRdData(20)            <=  reg_data(61)(20);                                 --DEBUG rx LPM LFKL override
          localRdData(22 downto 21)  <=  reg_data(61)(22 downto 21);                       --DEBUG rx monitor select
          localRdData(23)            <=  reg_data(61)(23);                                 --DEBUG rx pcs reset
          localRdData(24)            <=  reg_data(61)(24);                                 --DEBUG rx pma reset
          localRdData(25)            <=  reg_data(61)(25);                                 --DEBUG rx PRBS counter reset
          localRdData(28 downto 26)  <=  reg_data(61)(28 downto 26);                       --DEBUG rx PRBS select
        when 62 => --0x3e
          ...
          localRdData( 6 downto  3)  <=  reg_data(62)( 6 downto  3);                       --DEBUG tx diff control
          localRdData( 7)            <=  reg_data(62)( 7);                                 --DEBUG tx inhibit
          localRdData(14 downto  8)  <=  reg_data(62)(14 downto  8);                       --DEBUG tx main cursor
          localRdData(15)            <=  reg_data(62)(15);                                 --DEBUG tx pcs reset
          localRdData(16)            <=  reg_data(62)(16);                                 --DEBUG tx pma reset
          localRdData(17)            <=  reg_data(62)(17);                                 --DEBUG tx polarity
          localRdData(22 downto 18)  <=  reg_data(62)(22 downto 18);                       --DEBUG post cursor
          localRdData(23)            <=  reg_data(62)(23);                                 --DEBUG force PRBS error
          localRdData(26 downto 24)  <=  reg_data(62)(26 downto 24);                       --DEBUG PRBS select
          localRdData(31 downto 27)  <=  reg_data(62)(31 downto 27);                       --DEBUG pre cursor
        when 63 => --0x3f
        ...
        when 71 => --0x47
          localRdData( 0)            <=  reg_data(71)( 0);                                 --Reset counters in Monitor
        when 72 => --0x48
          localRdData(31 downto  0)  <=  Mon.CM(2).C2C.CNT.PHY_ERRORSTATE_COUNT;           --Count for phylane in error state
        when 73 => --0x49
          localRdData( 7 downto  0)  <=  reg_data(73)( 7 downto  0);                       --Baud 16x counter.  Set by 50Mhz/(baudrate(hz) * 16). Nominally 27
        ...
        when 77 => --0x4d
          localRdData( 0)            <=  reg_data(77)( 0);                                 --Reset monitoring error counters
        when 78 => --0x4e
        ...
        when 83 => --0x53
          localRdData(31 downto  0)  <=  reg_data(83)(31 downto  0);                       --Count to wait for in state machine before timing out (50Mhz clk)
  ...
  Ctrl.CM(1).MONITOR.SM_TIMEOUT        <=  reg_data(41)(31 downto  0);     
  Ctrl.CM(2).CTRL.ENABLE_UC            <=  reg_data(42)( 0);               
  Ctrl.CM(2).CTRL.ENABLE_PWR           <=  reg_data(42)( 1);               
  Ctrl.CM(2).CTRL.OVERRIDE_PWR_GOOD    <=  reg_data(42)( 2);               
  Ctrl.CM(2).CTRL.ERROR_STATE_RESET    <=  reg_data(42)( 8);               
  Ctrl.CM(2).CTRL.ENABLE_PHY_CTRL      <=  reg_data(42)(11);               
  Ctrl.CM(2).C2C.EYESCAN_TRIGGER       <=  reg_data(60)(23);               
  Ctrl.CM(2).C2C.EYESCAN_RESET         <=  reg_data(60)(22);               
  Ctrl.CM(2).C2C.INITIALIZE            <=  reg_data(60)( 5);               
  Ctrl.CM(2).C2C.RX.DFE_LPM_RESET      <=  reg_data(61)(17);               
  Ctrl.CM(2).C2C.RX.PRBS_SEL           <=  reg_data(61)(28 downto 26);     
  Ctrl.CM(2).C2C.RX.PRBS_CNT_RST       <=  reg_data(61)(25);               
  Ctrl.CM(2).C2C.RX.PMA_RESET          <=  reg_data(61)(24);               
  Ctrl.CM(2).C2C.RX.PCS_RESET          <=  reg_data(61)(23);               
  Ctrl.CM(2).C2C.RX.MON_SEL            <=  reg_data(61)(22 downto 21);     
  Ctrl.CM(2).C2C.RX.LPM_LFKL_OVERRIDE  <=  reg_data(61)(20);               
  Ctrl.CM(2).C2C.RX.LPM_HF_OVERRIDE    <=  reg_data(61)(19);               
  Ctrl.CM(2).C2C.RX.LPM_EN             <=  reg_data(61)(18);               
  Ctrl.CM(2).C2C.RX.DFE_LF_HOLD        <=  reg_data(61)(16);               
  Ctrl.CM(2).C2C.RX.DFE_AGC_OVERRIDE   <=  reg_data(61)(15);               
  Ctrl.CM(2).C2C.RX.DFE_AGC_HOLD       <=  reg_data(61)(14);               
  Ctrl.CM(2).C2C.RX.CDR_HOLD           <=  reg_data(61)(13);               
  Ctrl.CM(2).C2C.RX.BUF_RESET          <=  reg_data(61)(12);               
  Ctrl.CM(2).C2C.TX.DIFF_CTRL          <=  reg_data(62)( 6 downto  3);     
  Ctrl.CM(2).C2C.TX.INHIBIT            <=  reg_data(62)( 7);               
  Ctrl.CM(2).C2C.TX.MAIN_CURSOR        <=  reg_data(62)(14 downto  8);     
  Ctrl.CM(2).C2C.TX.PCS_RESET          <=  reg_data(62)(15);               
  Ctrl.CM(2).C2C.TX.PMA_RESET          <=  reg_data(62)(16);               
  Ctrl.CM(2).C2C.TX.POLARITY           <=  reg_data(62)(17);               
  Ctrl.CM(2).C2C.TX.POST_CURSOR        <=  reg_data(62)(22 downto 18);     
  Ctrl.CM(2).C2C.TX.PRBS_FORCE_ERR     <=  reg_data(62)(23);               
  Ctrl.CM(2).C2C.TX.PRBS_SEL           <=  reg_data(62)(26 downto 24);     
  Ctrl.CM(2).C2C.TX.PRE_CURSOR         <=  reg_data(62)(31 downto 27);     
  Ctrl.CM(2).C2C.CNT.RESET_COUNTERS    <=  reg_data(71)( 0);               
  Ctrl.CM(2).MONITOR.COUNT_16X_BAUD    <=  reg_data(73)( 7 downto  0);     
  Ctrl.CM(2).MONITOR.ERRORS.RESET      <=  reg_data(77)( 0);               
  Ctrl.CM(2).MONITOR.SM_TIMEOUT        <=  reg_data(83)(31 downto  0);     
  ...
  begin  -- process reg_writes
    if reset_axi_n = '0' then                 -- asynchronous reset (active low)
      ...
      reg_data(41)(31 downto  0)  <= DEFAULT_CM_CTRL_t.CM(1).MONITOR.SM_TIMEOUT;
      reg_data(42)( 0)  <= DEFAULT_CM_CTRL_t.CM(2).CTRL.ENABLE_UC;
      reg_data(42)( 1)  <= DEFAULT_CM_CTRL_t.CM(2).CTRL.ENABLE_PWR;
      reg_data(42)( 2)  <= DEFAULT_CM_CTRL_t.CM(2).CTRL.OVERRIDE_PWR_GOOD;
      reg_data(42)( 8)  <= DEFAULT_CM_CTRL_t.CM(2).CTRL.ERROR_STATE_RESET;
      reg_data(42)(11)  <= DEFAULT_CM_CTRL_t.CM(2).CTRL.ENABLE_PHY_CTRL;
      reg_data(60)(23)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.EYESCAN_TRIGGER;
      reg_data(60)(22)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.EYESCAN_RESET;
      reg_data(60)( 5)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.INITIALIZE;
      reg_data(61)(17)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.DFE_LPM_RESET;
      reg_data(61)(28 downto 26)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.PRBS_SEL;
      reg_data(61)(25)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.PRBS_CNT_RST;
      reg_data(61)(24)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.PMA_RESET;
      reg_data(61)(23)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.PCS_RESET;
      reg_data(61)(22 downto 21)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.MON_SEL;
      reg_data(61)(20)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.LPM_LFKL_OVERRIDE;
      reg_data(61)(19)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.LPM_HF_OVERRIDE;
      reg_data(61)(18)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.LPM_EN;
      reg_data(61)(16)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.DFE_LF_HOLD;
      reg_data(61)(15)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.DFE_AGC_OVERRIDE;
      reg_data(61)(14)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.DFE_AGC_HOLD;
      reg_data(61)(13)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.CDR_HOLD;
      reg_data(61)(12)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.RX.BUF_RESET;
      reg_data(62)( 6 downto  3)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.TX.DIFF_CTRL;
      reg_data(62)( 7)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.TX.INHIBIT;
      reg_data(62)(14 downto  8)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.TX.MAIN_CURSOR;
      reg_data(62)(15)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.TX.PCS_RESET;
      reg_data(62)(16)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.TX.PMA_RESET;
      reg_data(62)(17)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.TX.POLARITY;
      reg_data(62)(22 downto 18)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.TX.POST_CURSOR;
      reg_data(62)(23)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.TX.PRBS_FORCE_ERR;
      reg_data(62)(26 downto 24)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.TX.PRBS_SEL;
      reg_data(62)(31 downto 27)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.TX.PRE_CURSOR;
      reg_data(71)( 0)  <= DEFAULT_CM_CTRL_t.CM(2).C2C.CNT.RESET_COUNTERS;
      reg_data(73)( 7 downto  0)  <= DEFAULT_CM_CTRL_t.CM(2).MONITOR.COUNT_16X_BAUD;
      reg_data(77)( 0)  <= DEFAULT_CM_CTRL_t.CM(2).MONITOR.ERRORS.RESET;
      reg_data(83)(31 downto  0)  <= DEFAULT_CM_CTRL_t.CM(2).MONITOR.SM_TIMEOUT;
      ...
      if localWrEn = '1' then
        ...
        when 83 => --0x53
          reg_data(83)(31 downto  0)  <=  localWrData(31 downto  0);      --Count to wait for in state machine before timing out (50Mhz clk)
        when 35 => --0x23
          reg_data(35)( 0)            <=  localWrData( 0);                --Reset monitoring error counters
        when 71 => --0x47
          reg_data(71)( 0)            <=  localWrData( 0);                --Reset counters in Monitor
        when 41 => --0x29
          reg_data(41)(31 downto  0)  <=  localWrData(31 downto  0);      --Count to wait for in state machine before timing out (50Mhz clk)
        when 42 => --0x2a
          reg_data(42)( 0)            <=  localWrData( 0);                --Tell CM uC to power-up
          reg_data(42)( 1)            <=  localWrData( 1);                --Tell CM uC to power-up the rest of the CM
          reg_data(42)( 2)            <=  localWrData( 2);                --Ignore power good from CM
          reg_data(42)( 8)            <=  localWrData( 8);                --CM power is good
          reg_data(42)(11)            <=  localWrData(11);                --phy_lane_control is enabled
        when 77 => --0x4d
          reg_data(77)( 0)            <=  localWrData( 0);                --Reset monitoring error counters
        when 61 => --0x3d
          reg_data(61)(12)            <=  localWrData(12);                --DEBUG rx buf reset
          reg_data(61)(13)            <=  localWrData(13);                --DEBUG rx CDR hold
          reg_data(61)(14)            <=  localWrData(14);                --DEBUG rx DFE AGC HOLD
          reg_data(61)(15)            <=  localWrData(15);                --DEBUG rx DFE AGC OVERRIDE
          reg_data(61)(16)            <=  localWrData(16);                --DEBUG rx DFE LF HOLD
          reg_data(61)(17)            <=  localWrData(17);                --DEBUG rx DFE LPM RESET
          reg_data(61)(18)            <=  localWrData(18);                --DEBUG rx LPM ENABLE
          reg_data(61)(19)            <=  localWrData(19);                --DEBUG rx LPM HF OVERRIDE enable
          reg_data(61)(20)            <=  localWrData(20);                --DEBUG rx LPM LFKL override
          reg_data(61)(22 downto 21)  <=  localWrData(22 downto 21);      --DEBUG rx monitor select
          reg_data(61)(23)            <=  localWrData(23);                --DEBUG rx pcs reset
          reg_data(61)(24)            <=  localWrData(24);                --DEBUG rx pma reset
          reg_data(61)(25)            <=  localWrData(25);                --DEBUG rx PRBS counter reset
          reg_data(61)(28 downto 26)  <=  localWrData(28 downto 26);      --DEBUG rx PRBS select
        when 18 => --0x12
        ...
        when 73 => --0x49
          reg_data(73)( 7 downto  0)  <=  localWrData( 7 downto  0);      --Baud 16x counter.  Set by 50Mhz/(baudrate(hz) * 16). Nominally 27
        when 60 => --0x3c
          reg_data(60)( 5)            <=  localWrData( 5);                --C2C initialize
          reg_data(60)(22)            <=  localWrData(22);                --DEBUG eyescan reset
          reg_data(60)(23)            <=  localWrData(23);                --DEBUG eyescan trigger
        when 29 => --0x1d
          reg_data(29)( 0)            <=  localWrData( 0);                --Reset counters in Monitor
        when 62 => --0x3e
          reg_data(62)( 6 downto  3)  <=  localWrData( 6 downto  3);      --DEBUG tx diff control
          reg_data(62)( 7)            <=  localWrData( 7);                --DEBUG tx inhibit
          reg_data(62)(14 downto  8)  <=  localWrData(14 downto  8);      --DEBUG tx main cursor
          reg_data(62)(15)            <=  localWrData(15);                --DEBUG tx pcs reset
          reg_data(62)(16)            <=  localWrData(16);                --DEBUG tx pma reset
          reg_data(62)(17)            <=  localWrData(17);                --DEBUG tx polarity
          reg_data(62)(22 downto 18)  <=  localWrData(22 downto 18);      --DEBUG post cursor
          reg_data(62)(23)            <=  localWrData(23);                --DEBUG force PRBS error
          reg_data(62)(26 downto 24)  <=  localWrData(26 downto 24);      --DEBUG PRBS select
          reg_data(62)(31 downto 27)  <=  localWrData(31 downto 27);      --DEBUG pre cursor
        when 31 => --0x1f
