...
[AXI_C2C_MASTER C2C1          ${AXI_C2C_INTERCONNECT_NAME} ${AXI_MASTER_CLK} ${AXI_MASTER_RSTN} 50000000 1        ${INIT_CLK} 0xaa000000 32M 0x83c40000 64K]
[AXI_C2C_MASTER C2C2          ${AXI_C2C_INTERCONNECT_NAME} ${AXI_MASTER_CLK} ${AXI_MASTER_RSTN} 50000000 C2C1_PHY ${INIT_CLK} 0xac000000 32M 0x83d40000 64K]
