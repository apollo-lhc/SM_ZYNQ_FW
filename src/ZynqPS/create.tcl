...
[AXI_PL_DEV_CONNECT SERV      ${AXI_INTERCONNECT_NAME} PL_CLK PL_RESET_N 5000000 0x43C20000 8K]
...
[AXI_PL_DEV_CONNECT XVC1      ${AXI_INTERCONNECT_NAME} PL_CLK PL_RESET_N 50000000 0X40010000 64K] 
...
[AXI_PL_DEV_CONNECT CM        ${AXI_INTERCONNECT_NAME} PL_CLK PL_RESET_N 5000000 0x4000A000 8K]
[AXI_PL_DEV_CONNECT SM_INFO   ${AXI_INTERCONNECT_NAME} PL_CLK PL_RESET_N 5000000 0x4000C000 8K]
...
[AXI_PL_DEV_CONNECT TCDS     ${AXI_INTERCONNECT_NAME} TCDS_CLK PL_RESET_N 5000000 0x40002000 8K]
[AXI_PL_DEV_CONNECT TCDS_DRP ${AXI_INTERCONNECT_NAME} PL_CLK PL_RESET_N 5000000 0x4000E000 8K]
