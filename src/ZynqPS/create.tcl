...
[AXI_PL_DEV_CONNECT SERV      ${AXI_INTERCONNECT_NAME} PL_CLK PL_RESET_N ${PL_M_FREQ} 0x43C20000 8K]
...
[AXI_C2C_MASTER C2C1          ${AXI_C2C_INTERCONNECT_NAME} ${AXI_MASTER_CLK} ${AXI_MASTER_RSTN} 50000000 1        ${INIT_CLK} 100.000 0x8A000000 32M 0x83c40000 64K]
[AXI_C2C_MASTER C2C2          ${AXI_C2C_INTERCONNECT_NAME} ${AXI_MASTER_CLK} ${AXI_MASTER_RSTN} 50000000 C2C1_PHY ${INIT_CLK} 100.000 0x8C000000 32M 0x83d40000 64K]
...
#PL slaves
[AXI_PL_DEV_CONNECT SLAVE_I2C ${AXI_INTERCONNECT_NAME} PL_CLK PL_RESET_N ${PL_M_FREQ} 0x40008000 8K]
[AXI_PL_DEV_CONNECT CM        ${AXI_INTERCONNECT_NAME} PL_CLK PL_RESET_N ${PL_M_FREQ} 0x4000A000 8K]
[AXI_PL_DEV_CONNECT SM_INFO   ${AXI_INTERCONNECT_NAME} PL_CLK PL_RESET_N ${PL_M_FREQ} 0x4000C000 8K]
...
#[AXI_PL_DEV_CONNECT TCDS     ${AXI_INTERCONNECT_NAME} $TCDS_CLK $TCDS_RSTN 160308000 0x40002000 8K]
[AXI_PL_DEV_CONNECT TCDS     ${AXI_INTERCONNECT_NAME} PL_CLK PL_RESET_N ${PL_M_FREQ} 0x40002000 8K]
#[AXI_PL_DEV_CONNECT TCDS     ${AXI_INTERCONNECT_NAME} ${AXI_MASTER_CLK} ${AXI_MASTER_RSTN} 50000000 0x40002000 8K]
[AXI_PL_DEV_CONNECT TCDS_DRP ${AXI_INTERCONNECT_NAME} PL_CLK PL_RESET_N ${PL_M_FREQ} 0x4000E000 8K]
