...
[AXI_C2C_MASTER C2C1          ${AXI_INTERCONNECT_NAME} ${AXI_MASTER_CLK} ${AXI_MASTER_RSTN} 50000000 ${INIT_CLK} 0x7aa00000 64K 0x43c40000 64K]

#SI chip i2c core
[AXI_IP_I2C SI                ${AXI_INTERCONNECT_NAME} ${AXI_MASTER_CLK} ${AXI_MASTER_RSTN} 50000000]
...
#PL slaves
[AXI_PL_DEV_CONNECT SERV      ${AXI_INTERCONNECT_NAME} PL_CLK PL_RESET_N 5000000]
