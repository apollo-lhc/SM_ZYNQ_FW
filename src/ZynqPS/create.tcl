...
[AXI_IP_I2C SI                ${AXI_INTERCONNECT_NAME} ${AXI_MASTER_CLK} ${AXI_MASTER_RSTN} 50000000 0x41600000 8K]

# SM services slave (addr fixed for FSBL)
[AXI_PL_DEV_CONNECT SERV      ${AXI_INTERCONNECT_NAME} PL_CLK PL_RESET_N 50000000 0x43C20000 8K]
...
[AXI_C2C_MASTER C2C1          ${AXI_C2C_INTERCONNECT_NAME} ${AXI_MASTER_CLK} ${AXI_MASTER_RSTN} 50000000 1        ${INIT_CLK} 0x8A000000 32M 0x83c40000 64K]
[AXI_C2C_MASTER C2C2          ${AXI_C2C_INTERCONNECT_NAME} ${AXI_MASTER_CLK} ${AXI_MASTER_RSTN} 50000000 C2C1_PHY ${INIT_CLK} 0x8C000000 32M 0x83d40000 64K]

		              
#XVC cores	              
#[AXI_IP_XVC XVC1              ${AXI_INTERCONNECT_NAME} ${AXI_MASTER_CLK} ${AXI_MASTER_RSTN} 50000000 0x40010000 64K]
#Line below replaces line above; is this right or maybe use PL_clk and PL_reset insted of AXI clk and reset?
#[AXI_PL_DEV_CONNECT XVC1      ${AXI_INTERCONNECT_NAME} ${AXI_MASTER_CLK} ${AXI_MASTER_RSTN} 50000000 0X40010000 64K] 
[AXI_PL_DEV_CONNECT PLXVC1    ${AXI_INTERCONNECT_NAME} PL_CLK            PL_RESET_N         50000000 0X40010000 64K] 
...
#PL slaves
[AXI_PL_DEV_CONNECT SLAVE_I2C ${AXI_INTERCONNECT_NAME} PL_CLK PL_RESET_N 50000000 0x40008000 8K]
[AXI_PL_DEV_CONNECT CM        ${AXI_INTERCONNECT_NAME} PL_CLK PL_RESET_N 50000000 0x4000A000 8K]
[AXI_PL_DEV_CONNECT SM_INFO   ${AXI_INTERCONNECT_NAME} PL_CLK PL_RESET_N 50000000 0x4000C000 8K]

#XADC monitor
[AXI_IP_XADC MONITOR          ${AXI_INTERCONNECT_NAME} ${AXI_MASTER_CLK} ${AXI_MASTER_RSTN} 50000000 0x40040000 64K]
...
[AXI_IP_UART 115200 ${IRQ_ORR}/in0 CM1_UART   ${AXI_INTERCONNECT_NAME} ${AXI_MASTER_CLK} ${AXI_MASTER_RSTN} 50000000 0x40140000 8K]
[AXI_IP_UART 115200 ${IRQ_ORR}/in1 CM2_UART   ${AXI_INTERCONNECT_NAME} ${AXI_MASTER_CLK} ${AXI_MASTER_RSTN} 50000000 0x40150000 8K]
[AXI_IP_UART 115200 ${IRQ_ORR}/in2 ESM_UART   ${AXI_INTERCONNECT_NAME} ${AXI_MASTER_CLK} ${AXI_MASTER_RSTN} 50000000 0x40160000 8K]

[AXI_PL_DEV_CONNECT TCDS     ${AXI_INTERCONNECT_NAME} TCDS_CLK PL_RESET_N 50000000 0x40002000 8K]
[AXI_PL_DEV_CONNECT TCDS_DRP ${AXI_INTERCONNECT_NAME} PL_CLK PL_RESET_N   50000000 0x4000E000 8K]
