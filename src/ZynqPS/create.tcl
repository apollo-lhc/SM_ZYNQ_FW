...
#Line below replaces line above
[AXI_PL_DEV_CONNECT PLXVC    ${AXI_INTERCONNECT_NAME} PL_CLK            PL_RESET_N         50000000 0X40010000 64K] 
#Commented outline below, PLXVC is going to be an array with both XVC connections
