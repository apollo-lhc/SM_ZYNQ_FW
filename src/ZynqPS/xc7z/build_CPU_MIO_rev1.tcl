...
###make_bd_pins_external                                        [get_bd_pins ${ZYNQ_NAME}/ENET1_MDIO_MDC]
###make_bd_pins_external                                        [get_bd_pins ${ZYNQ_NAME}/ENET1_MDIO_I]
###make_bd_pins_external                                        [get_bd_pins ${ZYNQ_NAME}/ENET1_MDIO_O]
