...
architecture behavioral of SERV_interface is
  ...
  signal reg_data :  slv32_array_t(integer range 0 to 18);
  constant Default_reg_data : slv32_array_t(integer range 0 to 18) := (others => x"00000000");
begin  -- architecture behavioral
  ...
  begin  -- process reads
    ...
    if localRdReq = '1' then
      ...
      case to_integer(unsigned(localAddress(4 downto 0))) is
        ...
        when 16 => --0x10
          localRdData( 0)            <=  reg_data(16)( 0);                --Enable the JTAG lines to the CPLD
        when 18 => --0x12
  ...
  Ctrl.CPLD.ENABLE_JTAG       <=  reg_data(16)( 0);               
  ...
  begin  -- process reg_writes
    if reset_axi_n = '0' then                 -- asynchronous reset (active low)
      ...
      reg_data(16)( 0)  <= DEFAULT_SERV_CTRL_t.CPLD.ENABLE_JTAG;
      ...
      if localWrEn = '1' then
        ...
        when 16 => --0x10
          reg_data(16)( 0)            <=  localWrData( 0);                --Enable the JTAG lines to the CPLD
