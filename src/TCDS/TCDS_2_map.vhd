...
end entity TCDS_2_interface;
architecture behavioral of TCDS_2_interface is
  ...
  begin  -- process reg_writes
    if reset_axi_n = '0' then                 -- asynchronous reset (active low)
      ...
      if localWrEn = '1' then
        case to_integer(unsigned(localAddress(9 downto 0))) is
        when 512 => --0x200
          Ctrl.LTCDS.RESET.TX_PLL_AND_DATAPATH  <=  localWrData( 4);               
          Ctrl.LTCDS.RESET.TX_DATAPATH          <=  localWrData( 5);               
          Ctrl.LTCDS.RESET.RX_PLL_AND_DATAPATH  <=  localWrData( 6);               
          Ctrl.LTCDS.RESET.RX_DATAPATH          <=  localWrData( 7);               
          Ctrl.LTCDS.RESET.USERCLK_TX           <=  localWrData( 8);               
          Ctrl.LTCDS.RESET.USERCLK_RX           <=  localWrData( 9);               
