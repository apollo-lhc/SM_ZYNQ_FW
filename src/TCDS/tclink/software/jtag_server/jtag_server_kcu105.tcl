	...
	unset gty_test(addr,$sock)
        ...
        switch $ope {
          "fpga_program" {
              ...
              refresh_hw_device [get_hw_devices xcku040_0]
          ...
          "vio_ri" {
              ...
              refresh_hw_vio -update_output_values [get_hw_vios -of_objects [get_hw_devices xcku040_0] -filter {CELL_NAME=~"*vio_control"}]
              set probes [list $probe_name]			  
              set data [get_property INPUT_VALUE [get_hw_probes $probes -of_objects [get_hw_vios -of_objects [get_hw_devices xcku040_0] -filter {CELL_NAME=~"*vio_control"}]]]
			  puts $sock $data
		  }
          ...
          "vio_ro" {
              ...
              refresh_hw_vio -update_output_values [get_hw_vios -of_objects [get_hw_devices xcku040_0] -filter {CELL_NAME=~"*vio_control"}]
              set probes [list $probe_name]			  
              set data [get_property OUTPUT_VALUE [get_hw_probes $probes -of_objects [get_hw_vios -of_objects [get_hw_devices xcku040_0] -filter {CELL_NAME=~"*vio_control"}]]]
			  puts $sock $data
		  }
          ...
          "vio_w" {
              ...
              startgroup
              set probes [list $probe_name]			  
              set_property OUTPUT_VALUE $data [get_hw_probes $probes -of_objects [get_hw_vios -of_objects [get_hw_devices xcku040_0] -filter {CELL_NAME=~"*vio_control"}]]
              commit_hw_vio [get_hw_probes $probes -of_objects [get_hw_vios -of_objects [get_hw_devices xcku040_0] -filter {CELL_NAME=~"*vio_control"}]]
              endgroup
              refresh_hw_vio -update_output_values [get_hw_vios -of_objects [get_hw_devices xcku040_0] -filter {CELL_NAME=~"*vio_control"}]
			  puts $sock 1
		  }
...
connect_hw_server
open_hw_target
set_property PROGRAM.FILE {../../tclink_kcu105/tclink_kcu105.runs/impl_1/system_wrapper_kcu105.bit} [get_hw_devices xcku040_0]
set_property PROBES.FILE  {../../tclink_kcu105/tclink_kcu105.runs/impl_1/system_wrapper_kcu105.ltx} [get_hw_devices xcku040_0]
