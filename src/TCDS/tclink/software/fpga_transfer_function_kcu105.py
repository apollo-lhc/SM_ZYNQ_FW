...
#---                  Open sockets                             ---
#-----------------------------------------------------------------
tclink_fpga = TCLink('127.0.0.1', 8555, 'default', 'kcu105', Master)
...
# Preset VIO probes
print('------------------------------------------------------------------------------------------')
print('IMPORTANT: This script does not configure the link. Please perform it before running it...')
print('------------------------------------------------------------------------------------------')

# Check Tx and Rx are ready
...
if(tx_ready):
  ...
  print('- FAILURE: Tx is not ready, please reset the transmitter and re-run script')
if(rx_ready):
  print('- Rx is ready')
else:
  print('- FAILURE: Rx is not ready, please reset the receiver and re-run script')
