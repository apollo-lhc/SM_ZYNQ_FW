...
begin  -- architecture behavioral
  ...
  begin  -- process reg_writes
    if reset_axi_n = '0' then                 -- asynchronous reset (active low)
      reg_data( 8)( 0)  <= DEFAULT_TCDS2_CTRL_t.TCDS_2.link_test.control.link_test_mode;
      reg_data( 9)( 0)  <= DEFAULT_TCDS2_CTRL_t.TCDS_2.link_test.control.prbs_gen_reset;
      reg_data( 9)( 1)  <= DEFAULT_TCDS2_CTRL_t.TCDS_2.link_test.control.prbs_chk_reset;
      reg_data(64)( 8)  <= DEFAULT_TCDS2_CTRL_t.TCDS_2.csr.control.mgt_reset_rx_datapath;
      reg_data(64)(12)  <= DEFAULT_TCDS2_CTRL_t.TCDS_2.csr.control.tclink_channel_ctrl_reset;
      reg_data(64)(13)  <= DEFAULT_TCDS2_CTRL_t.TCDS_2.csr.control.tclink_channel_ctrl_enable;
      reg_data(64)(14)  <= DEFAULT_TCDS2_CTRL_t.TCDS_2.csr.control.tclink_channel_ctrl_gentle;
      reg_data(64)(16)  <= DEFAULT_TCDS2_CTRL_t.TCDS_2.csr.control.tclink_close_loop;
      reg_data(64)( 0)  <= DEFAULT_TCDS2_CTRL_t.TCDS_2.csr.control.reset_all;
      reg_data(64)( 4)  <= DEFAULT_TCDS2_CTRL_t.TCDS_2.csr.control.mgt_reset_all;
      reg_data(64)( 5)  <= DEFAULT_TCDS2_CTRL_t.TCDS_2.csr.control.mgt_reset_tx_pll_and_datapath;
      reg_data(64)( 6)  <= DEFAULT_TCDS2_CTRL_t.TCDS_2.csr.control.mgt_reset_tx_datapath;
      reg_data(64)( 7)  <= DEFAULT_TCDS2_CTRL_t.TCDS_2.csr.control.mgt_reset_rx_pll_and_datapath;
      reg_data(68)( 0)  <= DEFAULT_TCDS2_CTRL_t.TCDS_2.csr.control.mgt_rx_dfe_vs_lpm;
      reg_data(71)( 0)  <= DEFAULT_TCDS2_CTRL_t.TCDS_2.csr.control.fec_monitor_reset;
      reg_data(68)( 1)  <= DEFAULT_TCDS2_CTRL_t.TCDS_2.csr.control.mgt_rx_dfe_vs_lpm_reset;
      reg_data(80)( 0)  <= DEFAULT_TCDS2_CTRL_t.TCDS_2.csr.control.tclink_param_enable_mirror;
      reg_data(78)( 3 downto  0)  <= DEFAULT_TCDS2_CTRL_t.TCDS_2.csr.control.tclink_param_aie;
      reg_data(78)( 4)  <= DEFAULT_TCDS2_CTRL_t.TCDS_2.csr.control.tclink_param_aie_enable;
      reg_data(67)( 9 downto  0)  <= DEFAULT_TCDS2_CTRL_t.TCDS_2.csr.control.phase_cdc40_tx_calib;
      reg_data(67)(10)  <= DEFAULT_TCDS2_CTRL_t.TCDS_2.csr.control.phase_cdc40_tx_force;
      reg_data(78)(11 downto  8)  <= DEFAULT_TCDS2_CTRL_t.TCDS_2.csr.control.tclink_param_ape;
      reg_data(73)(11 downto  0)  <= DEFAULT_TCDS2_CTRL_t.TCDS_2.csr.control.tclink_param_phase_detector_navg;
      reg_data(72)(15 downto  0)  <= DEFAULT_TCDS2_CTRL_t.TCDS_2.csr.control.tclink_param_metastability_deglitch;
      reg_data(67)(18 downto 16)  <= DEFAULT_TCDS2_CTRL_t.TCDS_2.csr.control.phase_cdc40_rx_calib;
      reg_data(67)(19)  <= DEFAULT_TCDS2_CTRL_t.TCDS_2.csr.control.phase_cdc40_rx_force;
      reg_data(67)(30 downto 24)  <= DEFAULT_TCDS2_CTRL_t.TCDS_2.csr.control.phase_pi_tx_calib;
      reg_data(67)(31)  <= DEFAULT_TCDS2_CTRL_t.TCDS_2.csr.control.phase_pi_tx_force;
      reg_data(79)(31 downto 16)  <= DEFAULT_TCDS2_CTRL_t.TCDS_2.csr.control.tclink_param_sigma_delta_clk_div;
      reg_data(65)(31 downto  0)  <= DEFAULT_TCDS2_CTRL_t.TCDS_2.csr.control.tclink_phase_offset.lo;
      reg_data(66)(15 downto  0)  <= DEFAULT_TCDS2_CTRL_t.TCDS_2.csr.control.tclink_phase_offset.hi;
      reg_data(69)( 4)  <= DEFAULT_TCDS2_CTRL_t.TCDS_2.csr.control.mgt_rxeq_params.lpm.rxlpmgcovrden;
      reg_data(69)( 5)  <= DEFAULT_TCDS2_CTRL_t.TCDS_2.csr.control.mgt_rxeq_params.lpm.rxlpmhfovrden;
      reg_data(69)( 6)  <= DEFAULT_TCDS2_CTRL_t.TCDS_2.csr.control.mgt_rxeq_params.lpm.rxlpmlfklovrden;
      reg_data(69)( 7)  <= DEFAULT_TCDS2_CTRL_t.TCDS_2.csr.control.mgt_rxeq_params.lpm.rxlpmosovrden;
      reg_data(70)( 8)  <= DEFAULT_TCDS2_CTRL_t.TCDS_2.csr.control.mgt_rxeq_params.dfe.rxosovrden;
      reg_data(70)( 9)  <= DEFAULT_TCDS2_CTRL_t.TCDS_2.csr.control.mgt_rxeq_params.dfe.rxdfeagcovrden;
      reg_data(70)(10)  <= DEFAULT_TCDS2_CTRL_t.TCDS_2.csr.control.mgt_rxeq_params.dfe.rxdfelfovrden;
      reg_data(70)(11)  <= DEFAULT_TCDS2_CTRL_t.TCDS_2.csr.control.mgt_rxeq_params.dfe.rxdfeutovrden;
      reg_data(70)(12)  <= DEFAULT_TCDS2_CTRL_t.TCDS_2.csr.control.mgt_rxeq_params.dfe.rxdfevpovrden;
      reg_data(74)(31 downto  0)  <= DEFAULT_TCDS2_CTRL_t.TCDS_2.csr.control.tclink_param_modulo_carrier_period.lo;
      reg_data(75)(15 downto  0)  <= DEFAULT_TCDS2_CTRL_t.TCDS_2.csr.control.tclink_param_modulo_carrier_period.hi;
      reg_data(76)(31 downto  0)  <= DEFAULT_TCDS2_CTRL_t.TCDS_2.csr.control.tclink_param_master_rx_ui_period.lo;
      reg_data(77)(15 downto  0)  <= DEFAULT_TCDS2_CTRL_t.TCDS_2.csr.control.tclink_param_master_rx_ui_period.hi;
      reg_data(81)(31 downto  0)  <= DEFAULT_TCDS2_CTRL_t.TCDS_2.csr.control.tclink_param_adco.lo;
      reg_data(82)(15 downto  0)  <= DEFAULT_TCDS2_CTRL_t.TCDS_2.csr.control.tclink_param_adco.hi;
