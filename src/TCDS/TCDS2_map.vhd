...
architecture behavioral of TCDS2_interface is
  ...
  signal reg_data :  slv32_array_t(integer range 0 to 349);
  constant Default_reg_data : slv32_array_t(integer range 0 to 349) := (others => x"00000000");
begin  -- architecture behavioral
  ...
  begin  -- process reads
    ...
    if localRdReq = '1' then
      ...
      case to_integer(unsigned(localAddress(8 downto 0))) is
        ...
        when 0 => --0x0
          localRdData( 0)            <=  Mon.TCDS2.hw_cfg.has_spy_registers;                        --
          localRdData( 1)            <=  Mon.TCDS2.hw_cfg.has_link_test_mode;                       --
        when 8 => --0x8
        ...
        when 12 => --0xc
          localRdData( 0)            <=  Mon.TCDS2.link_test.status.prbs_chk_error;                 --
          localRdData( 1)            <=  Mon.TCDS2.link_test.status.prbs_chk_locked;                --
        when 13 => --0xd
          localRdData(31 downto  0)  <=  Mon.TCDS2.link_test.status.prbs_chk_unlock_counter;        --
        when 14 => --0xe
          localRdData( 7 downto  0)  <=  Mon.TCDS2.link_test.status.prbs_gen_o_hint;                --
          localRdData(15 downto  8)  <=  Mon.TCDS2.link_test.status.prbs_chk_i_hint;                --
          localRdData(23 downto 16)  <=  Mon.TCDS2.link_test.status.prbs_chk_o_hint;                --
        when 64 => --0x40
        ...
        when 96 => --0x60
          localRdData( 0)            <=  Mon.TCDS2.csr.status.is_link_optical;                      --
          localRdData( 1)            <=  Mon.TCDS2.csr.status.is_link_speed_10g;                    --
          localRdData( 2)            <=  Mon.TCDS2.csr.status.is_leader;                            --
          localRdData( 3)            <=  Mon.TCDS2.csr.status.is_quad_leader;                       --
          localRdData( 4)            <=  Mon.TCDS2.csr.status.is_mgt_rx_mode_lpm;                   --
        when 97 => --0x61
          localRdData( 0)            <=  Mon.TCDS2.csr.status.mmcm_locked;                          --
          localRdData( 1)            <=  Mon.TCDS2.csr.status.mgt_power_good;                       --
          localRdData( 4)            <=  Mon.TCDS2.csr.status.mgt_tx_pll_locked;                    --
          localRdData( 5)            <=  Mon.TCDS2.csr.status.mgt_rx_pll_locked;                    --
          localRdData( 8)            <=  Mon.TCDS2.csr.status.mgt_reset_tx_done;                    --
          localRdData( 9)            <=  Mon.TCDS2.csr.status.mgt_reset_rx_done;                    --
          localRdData(12)            <=  Mon.TCDS2.csr.status.mgt_tx_ready;                         --
          localRdData(13)            <=  Mon.TCDS2.csr.status.mgt_rx_ready;                         --
          localRdData(14)            <=  Mon.TCDS2.csr.status.cdc40_tx_ready;                       --
          localRdData(15)            <=  Mon.TCDS2.csr.status.cdc40_rx_ready;                       --
          localRdData(16)            <=  Mon.TCDS2.csr.status.rx_data_not_idle;                     --
          localRdData(17)            <=  Mon.TCDS2.csr.status.rx_frame_locked;                      --
          localRdData(18)            <=  Mon.TCDS2.csr.status.tx_user_data_ready;                   --
          localRdData(19)            <=  Mon.TCDS2.csr.status.rx_user_data_ready;                   --
          localRdData(20)            <=  Mon.TCDS2.csr.status.tclink_ready;                         --
        when 98 => --0x62
          localRdData(30 downto  0)  <=  Mon.TCDS2.csr.status.initializer_fsm_state;                --
          localRdData(31)            <=  Mon.TCDS2.csr.status.initializer_fsm_running;              --
        when 99 => --0x63
          localRdData(31 downto  0)  <=  Mon.TCDS2.csr.status.rx_frame_unlock_counter;              --
        when 100 => --0x64
          localRdData( 9 downto  0)  <=  Mon.TCDS2.csr.status.phase_cdc40_tx_measured;              --
          localRdData(18 downto 16)  <=  Mon.TCDS2.csr.status.phase_cdc40_rx_measured;              --
          localRdData(30 downto 24)  <=  Mon.TCDS2.csr.status.phase_pi_tx_measured;                 --
        when 101 => --0x65
          localRdData( 0)            <=  Mon.TCDS2.csr.status.fec_correction_applied;               --Latched flag indicating that the link is not error-free.
        when 102 => --0x66
          localRdData( 0)            <=  Mon.TCDS2.csr.status.tclink_loop_closed;                   --High if the TCLink control loop is closed (i.e. configured as closed and not internally opened due to issues).
          localRdData( 1)            <=  Mon.TCDS2.csr.status.tclink_operation_error;               --High if the TCLink encountered a DCO error during operation.
        when 103 => --0x67
          localRdData(31 downto  0)  <=  Mon.TCDS2.csr.status.tclink_phase_measured;                --Phase value measured by the TCLink. Signed two's complement number. Conversion to ps: DDMTD_UNIT / navg * value.
        when 104 => --0x68
          localRdData(31 downto  0)  <=  Mon.TCDS2.csr.status.tclink_phase_error.lo;                --
        when 105 => --0x69
          localRdData(15 downto  0)  <=  Mon.TCDS2.csr.status.tclink_phase_error.hi;                --
        when 256 => --0x100
  ...
  Ctrl.TCDS2.link_test.control.link_test_mode                   <=  reg_data( 8)( 0);               
  Ctrl.TCDS2.link_test.control.prbs_gen_reset                   <=  reg_data( 9)( 0);               
  Ctrl.TCDS2.link_test.control.prbs_chk_reset                   <=  reg_data( 9)( 1);               
  Ctrl.TCDS2.csr.control.mgt_reset_rx_datapath                  <=  reg_data(64)( 8);               
  Ctrl.TCDS2.csr.control.tclink_channel_ctrl_reset              <=  reg_data(64)(12);               
  Ctrl.TCDS2.csr.control.tclink_channel_ctrl_enable             <=  reg_data(64)(13);               
  Ctrl.TCDS2.csr.control.tclink_channel_ctrl_gentle             <=  reg_data(64)(14);               
  Ctrl.TCDS2.csr.control.tclink_close_loop                      <=  reg_data(64)(16);               
  Ctrl.TCDS2.csr.control.reset_all                              <=  reg_data(64)( 0);               
  Ctrl.TCDS2.csr.control.mgt_reset_all                          <=  reg_data(64)( 4);               
  Ctrl.TCDS2.csr.control.mgt_reset_tx_pll_and_datapath          <=  reg_data(64)( 5);               
  Ctrl.TCDS2.csr.control.mgt_reset_tx_datapath                  <=  reg_data(64)( 6);               
  Ctrl.TCDS2.csr.control.mgt_reset_rx_pll_and_datapath          <=  reg_data(64)( 7);               
  Ctrl.TCDS2.csr.control.mgt_rx_dfe_vs_lpm                      <=  reg_data(68)( 0);               
  Ctrl.TCDS2.csr.control.fec_monitor_reset                      <=  reg_data(71)( 0);               
  Ctrl.TCDS2.csr.control.mgt_rx_dfe_vs_lpm_reset                <=  reg_data(68)( 1);               
  Ctrl.TCDS2.csr.control.tclink_param_enable_mirror             <=  reg_data(80)( 0);               
  Ctrl.TCDS2.csr.control.tclink_param_aie                       <=  reg_data(78)( 3 downto  0);     
  Ctrl.TCDS2.csr.control.tclink_param_aie_enable                <=  reg_data(78)( 4);               
  Ctrl.TCDS2.csr.control.phase_cdc40_tx_calib                   <=  reg_data(67)( 9 downto  0);     
  Ctrl.TCDS2.csr.control.phase_cdc40_tx_force                   <=  reg_data(67)(10);               
  Ctrl.TCDS2.csr.control.tclink_param_ape                       <=  reg_data(78)(11 downto  8);     
  Ctrl.TCDS2.csr.control.tclink_param_phase_detector_navg       <=  reg_data(73)(11 downto  0);     
  Ctrl.TCDS2.csr.control.tclink_param_metastability_deglitch    <=  reg_data(72)(15 downto  0);     
  Ctrl.TCDS2.csr.control.phase_cdc40_rx_calib                   <=  reg_data(67)(18 downto 16);     
  Ctrl.TCDS2.csr.control.phase_cdc40_rx_force                   <=  reg_data(67)(19);               
  Ctrl.TCDS2.csr.control.phase_pi_tx_calib                      <=  reg_data(67)(30 downto 24);     
  Ctrl.TCDS2.csr.control.phase_pi_tx_force                      <=  reg_data(67)(31);               
  Ctrl.TCDS2.csr.control.tclink_param_sigma_delta_clk_div       <=  reg_data(79)(31 downto 16);     
  Ctrl.TCDS2.csr.control.tclink_phase_offset.lo                 <=  reg_data(65)(31 downto  0);     
  Ctrl.TCDS2.csr.control.tclink_phase_offset.hi                 <=  reg_data(66)(15 downto  0);     
  Ctrl.TCDS2.csr.control.mgt_rxeq_params.lpm.rxlpmgcovrden      <=  reg_data(69)( 4);               
  Ctrl.TCDS2.csr.control.mgt_rxeq_params.lpm.rxlpmhfovrden      <=  reg_data(69)( 5);               
  Ctrl.TCDS2.csr.control.mgt_rxeq_params.lpm.rxlpmlfklovrden    <=  reg_data(69)( 6);               
  Ctrl.TCDS2.csr.control.mgt_rxeq_params.lpm.rxlpmosovrden      <=  reg_data(69)( 7);               
  Ctrl.TCDS2.csr.control.mgt_rxeq_params.dfe.rxosovrden         <=  reg_data(70)( 8);               
  Ctrl.TCDS2.csr.control.mgt_rxeq_params.dfe.rxdfeagcovrden     <=  reg_data(70)( 9);               
  Ctrl.TCDS2.csr.control.mgt_rxeq_params.dfe.rxdfelfovrden      <=  reg_data(70)(10);               
  Ctrl.TCDS2.csr.control.mgt_rxeq_params.dfe.rxdfeutovrden      <=  reg_data(70)(11);               
  Ctrl.TCDS2.csr.control.mgt_rxeq_params.dfe.rxdfevpovrden      <=  reg_data(70)(12);               
  Ctrl.TCDS2.csr.control.tclink_param_modulo_carrier_period.lo  <=  reg_data(74)(31 downto  0);     
  Ctrl.TCDS2.csr.control.tclink_param_modulo_carrier_period.hi  <=  reg_data(75)(15 downto  0);     
  Ctrl.TCDS2.csr.control.tclink_param_master_rx_ui_period.lo    <=  reg_data(76)(31 downto  0);     
  Ctrl.TCDS2.csr.control.tclink_param_master_rx_ui_period.hi    <=  reg_data(77)(15 downto  0);     
  Ctrl.TCDS2.csr.control.tclink_param_adco.lo                   <=  reg_data(81)(31 downto  0);     
  Ctrl.TCDS2.csr.control.tclink_param_adco.hi                   <=  reg_data(82)(15 downto  0);     


  reg_writes: process (clk_axi, reset_axi_n) is
  begin  -- process reg_writes
    if reset_axi_n = '0' then                 -- asynchronous reset (active low)
      reg_data( 8)( 0)  <= DEFAULT_TCDS2_CTRL_t.TCDS2.link_test.control.link_test_mode;
      reg_data( 9)( 0)  <= DEFAULT_TCDS2_CTRL_t.TCDS2.link_test.control.prbs_gen_reset;
      reg_data( 9)( 1)  <= DEFAULT_TCDS2_CTRL_t.TCDS2.link_test.control.prbs_chk_reset;
      reg_data(64)( 8)  <= DEFAULT_TCDS2_CTRL_t.TCDS2.csr.control.mgt_reset_rx_datapath;
      reg_data(64)(12)  <= DEFAULT_TCDS2_CTRL_t.TCDS2.csr.control.tclink_channel_ctrl_reset;
      reg_data(64)(13)  <= DEFAULT_TCDS2_CTRL_t.TCDS2.csr.control.tclink_channel_ctrl_enable;
      reg_data(64)(14)  <= DEFAULT_TCDS2_CTRL_t.TCDS2.csr.control.tclink_channel_ctrl_gentle;
      reg_data(64)(16)  <= DEFAULT_TCDS2_CTRL_t.TCDS2.csr.control.tclink_close_loop;
      reg_data(64)( 0)  <= DEFAULT_TCDS2_CTRL_t.TCDS2.csr.control.reset_all;
      reg_data(64)( 4)  <= DEFAULT_TCDS2_CTRL_t.TCDS2.csr.control.mgt_reset_all;
      reg_data(64)( 5)  <= DEFAULT_TCDS2_CTRL_t.TCDS2.csr.control.mgt_reset_tx_pll_and_datapath;
      reg_data(64)( 6)  <= DEFAULT_TCDS2_CTRL_t.TCDS2.csr.control.mgt_reset_tx_datapath;
      reg_data(64)( 7)  <= DEFAULT_TCDS2_CTRL_t.TCDS2.csr.control.mgt_reset_rx_pll_and_datapath;
      reg_data(68)( 0)  <= DEFAULT_TCDS2_CTRL_t.TCDS2.csr.control.mgt_rx_dfe_vs_lpm;
      reg_data(71)( 0)  <= DEFAULT_TCDS2_CTRL_t.TCDS2.csr.control.fec_monitor_reset;
      reg_data(68)( 1)  <= DEFAULT_TCDS2_CTRL_t.TCDS2.csr.control.mgt_rx_dfe_vs_lpm_reset;
      reg_data(80)( 0)  <= DEFAULT_TCDS2_CTRL_t.TCDS2.csr.control.tclink_param_enable_mirror;
      reg_data(78)( 3 downto  0)  <= DEFAULT_TCDS2_CTRL_t.TCDS2.csr.control.tclink_param_aie;
      reg_data(78)( 4)  <= DEFAULT_TCDS2_CTRL_t.TCDS2.csr.control.tclink_param_aie_enable;
      reg_data(67)( 9 downto  0)  <= DEFAULT_TCDS2_CTRL_t.TCDS2.csr.control.phase_cdc40_tx_calib;
      reg_data(67)(10)  <= DEFAULT_TCDS2_CTRL_t.TCDS2.csr.control.phase_cdc40_tx_force;
      reg_data(78)(11 downto  8)  <= DEFAULT_TCDS2_CTRL_t.TCDS2.csr.control.tclink_param_ape;
      reg_data(73)(11 downto  0)  <= DEFAULT_TCDS2_CTRL_t.TCDS2.csr.control.tclink_param_phase_detector_navg;
      reg_data(72)(15 downto  0)  <= DEFAULT_TCDS2_CTRL_t.TCDS2.csr.control.tclink_param_metastability_deglitch;
      reg_data(67)(18 downto 16)  <= DEFAULT_TCDS2_CTRL_t.TCDS2.csr.control.phase_cdc40_rx_calib;
      reg_data(67)(19)  <= DEFAULT_TCDS2_CTRL_t.TCDS2.csr.control.phase_cdc40_rx_force;
      reg_data(67)(30 downto 24)  <= DEFAULT_TCDS2_CTRL_t.TCDS2.csr.control.phase_pi_tx_calib;
      reg_data(67)(31)  <= DEFAULT_TCDS2_CTRL_t.TCDS2.csr.control.phase_pi_tx_force;
      reg_data(79)(31 downto 16)  <= DEFAULT_TCDS2_CTRL_t.TCDS2.csr.control.tclink_param_sigma_delta_clk_div;
      reg_data(65)(31 downto  0)  <= DEFAULT_TCDS2_CTRL_t.TCDS2.csr.control.tclink_phase_offset.lo;
      reg_data(66)(15 downto  0)  <= DEFAULT_TCDS2_CTRL_t.TCDS2.csr.control.tclink_phase_offset.hi;
      reg_data(69)( 4)  <= DEFAULT_TCDS2_CTRL_t.TCDS2.csr.control.mgt_rxeq_params.lpm.rxlpmgcovrden;
      reg_data(69)( 5)  <= DEFAULT_TCDS2_CTRL_t.TCDS2.csr.control.mgt_rxeq_params.lpm.rxlpmhfovrden;
      reg_data(69)( 6)  <= DEFAULT_TCDS2_CTRL_t.TCDS2.csr.control.mgt_rxeq_params.lpm.rxlpmlfklovrden;
      reg_data(69)( 7)  <= DEFAULT_TCDS2_CTRL_t.TCDS2.csr.control.mgt_rxeq_params.lpm.rxlpmosovrden;
      reg_data(70)( 8)  <= DEFAULT_TCDS2_CTRL_t.TCDS2.csr.control.mgt_rxeq_params.dfe.rxosovrden;
      reg_data(70)( 9)  <= DEFAULT_TCDS2_CTRL_t.TCDS2.csr.control.mgt_rxeq_params.dfe.rxdfeagcovrden;
      reg_data(70)(10)  <= DEFAULT_TCDS2_CTRL_t.TCDS2.csr.control.mgt_rxeq_params.dfe.rxdfelfovrden;
      reg_data(70)(11)  <= DEFAULT_TCDS2_CTRL_t.TCDS2.csr.control.mgt_rxeq_params.dfe.rxdfeutovrden;
      reg_data(70)(12)  <= DEFAULT_TCDS2_CTRL_t.TCDS2.csr.control.mgt_rxeq_params.dfe.rxdfevpovrden;
      reg_data(74)(31 downto  0)  <= DEFAULT_TCDS2_CTRL_t.TCDS2.csr.control.tclink_param_modulo_carrier_period.lo;
      reg_data(75)(15 downto  0)  <= DEFAULT_TCDS2_CTRL_t.TCDS2.csr.control.tclink_param_modulo_carrier_period.hi;
      reg_data(76)(31 downto  0)  <= DEFAULT_TCDS2_CTRL_t.TCDS2.csr.control.tclink_param_master_rx_ui_period.lo;
      reg_data(77)(15 downto  0)  <= DEFAULT_TCDS2_CTRL_t.TCDS2.csr.control.tclink_param_master_rx_ui_period.hi;
      reg_data(81)(31 downto  0)  <= DEFAULT_TCDS2_CTRL_t.TCDS2.csr.control.tclink_param_adco.lo;
      reg_data(82)(15 downto  0)  <= DEFAULT_TCDS2_CTRL_t.TCDS2.csr.control.tclink_param_adco.hi;
