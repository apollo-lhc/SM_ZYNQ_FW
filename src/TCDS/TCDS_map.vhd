...
architecture behavioral of TCDS_interface is
  ...
  signal reg_data :  slv32_array_t(integer range 0 to 561);
  constant Default_reg_data : slv32_array_t(integer range 0 to 561) := (others => x"00000000");
begin  -- architecture behavioral
  ...
  begin  -- process reads
    ...
    if localRdReq = '1' then
      localRdAck  <= '1';
      case localAddress(9 downto 0) is
        when x"0" =>
