...
set_property -dict {PACKAGE_PIN AF22 IOSTANDARD LVCMOS33} [get_ports {CM1_GPIO[0]}]
...
set_property -dict {PACKAGE_PIN U2}  [get_ports AXI_C2C_Tx_P[0] ]
set_property -dict {PACKAGE_PIN U1}  [get_ports AXI_C2C_Tx_N[0] ]
set_property -dict {PACKAGE_PIN V4}  [get_ports AXI_C2C_Rx_P[0] ]
set_property -dict {PACKAGE_PIN V3}  [get_ports AXI_C2C_Rx_N[0] ]

set_property -dict {PACKAGE_PIN R2}  [get_ports AXI_C2C_Tx_P[1] ]
set_property -dict {PACKAGE_PIN R1}  [get_ports AXI_C2C_Tx_N[1] ]
set_property -dict {PACKAGE_PIN T4}  [get_ports AXI_C2C_Rx_P[1] ]
set_property -dict {PACKAGE_PIN T3}  [get_ports AXI_C2C_Rx_N[1] ]
#
#set_property -dict {PACKAGE_PIN AA2}  [get_ports AXI_C2C_Tx_P[2] ]
#set_property -dict {PACKAGE_PIN AA1}  [get_ports AXI_C2C_Tx_N[2] ]
#set_property -dict {PACKAGE_PIN AB4}  [get_ports AXI_C2C_Rx_P[2] ]
#set_property -dict {PACKAGE_PIN AB3}  [get_ports AXI_C2C_Rx_N[2] ]
#
#set_property -dict {PACKAGE_PIN W2}  [get_ports AXI_C2C_Tx_P[3] ]
#set_property -dict {PACKAGE_PIN W1}  [get_ports AXI_C2C_Tx_N[3] ]
#set_property -dict {PACKAGE_PIN Y4}  [get_ports AXI_C2C_Rx_P[3] ]
#set_property -dict {PACKAGE_PIN Y3}  [get_ports AXI_C2C_Rx_N[3] ]

#set_property -dict {PACKAGE_PIN AA2}  [get_ports AXI_C2C_Tx_P[1] ]
#set_property -dict {PACKAGE_PIN AA1}  [get_ports AXI_C2C_Tx_N[1] ]
#set_property -dict {PACKAGE_PIN AB4}  [get_ports AXI_C2C_Rx_P[1] ]
#set_property -dict {PACKAGE_PIN AB3}  [get_ports AXI_C2C_Rx_N[1] ]
