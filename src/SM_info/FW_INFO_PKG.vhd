...
package FW_INFO_CTRL is
  ...
  type FW_INFO_CTRL_t is record
    BUILD_DATE                 : FW_INFO_BUILD_DATE_CTRL_t;
    BUILD_TIME                 : FW_INFO_BUILD_TIME_CTRL_t;
  end record FW_INFO_CTRL_t;
