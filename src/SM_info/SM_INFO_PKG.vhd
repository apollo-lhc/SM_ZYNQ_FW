...
-- Created : 2021-04-28 10:02:34.098197.
library IEEE;
...
package SM_INFO_CTRL is
  type SM_INFO_BUILD_DATE_MON_t is record
    DAY                        :std_logic_vector( 7 downto 0);
    MONTH                      :std_logic_vector( 7 downto 0);
    YEAR                       :std_logic_vector(15 downto 0);
  end record SM_INFO_BUILD_DATE_MON_t;


  type SM_INFO_BUILD_TIME_MON_t is record
    SEC                        :std_logic_vector( 7 downto 0);
    MIN                        :std_logic_vector( 7 downto 0);
    HOUR                       :std_logic_vector( 7 downto 0);
  end record SM_INFO_BUILD_TIME_MON_t;


  type SM_INFO_FPGA_MON_t is record
