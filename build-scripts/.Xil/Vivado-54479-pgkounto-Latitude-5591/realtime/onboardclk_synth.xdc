set_property SRC_FILE_INFO {cfile:/home/pgkounto/Project/hog_SM/SM_ZYNQ_FW/configs/rev2a_xc7z035/autogen/cores/onboardclk/onboardclk.xdc rfile:../../../../configs/rev2a_xc7z035/autogen/cores/onboardclk/onboardclk.xdc id:1 order:EARLY scoped_inst:inst} [current_design]
...
set_property src_info {type:PI file:{} line:-1 export:INPUT save:INPUT read:READ} [current_design]
create_generated_clock -name clk_125MHz_onboardclk -source [get_pins inst/mmcm_adv_inst/CLKIN1] -edges {1 2 3} -edge_shift {0.000 1.500 3.000} -add -master_clock [get_clocks clk_in1_p] [get_pins inst/mmcm_adv_inst/CLKOUT2]
