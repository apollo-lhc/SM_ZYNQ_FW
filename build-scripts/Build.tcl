...
#Panos add
proc pause {{message "Start build - Hit Enter to continue ==> "}} {
...
#Panos add
proc pause {{message "Start Generate files for os build - Hit Enter to continue ==> "}} {
    puts -nonewline $message
    flush stdout
    gets stdin
}
...
#Panos add
proc pause {{message "End Generate files for os build - Hit Enter to continue ==> "}} {
    puts -nonewline $message
    flush stdout
    gets stdin
}
